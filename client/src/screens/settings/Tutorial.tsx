...
const Tutorial = () => {
  ...
  return (
    <Box>
      ...
      <Text p={2} color={utils.getMutedTextColor(utils.getTextColor(bg_color))}>Note: When clicking on a language from the list, press <Kbd>backspace</Kbd> once.</Text>
      <Image mt={5} pr={5} src={src_code} />
      <Text mt={2}>List of supported languages:</Text>
      <Box ml={5} color={utils.getMutedTextColor(utils.getTextColor(bg_color))}>
        <UnorderedList>
