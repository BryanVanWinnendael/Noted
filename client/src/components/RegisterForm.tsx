...
const SignupForm = () => {
  ...
  return (
    <form class="grid grid-cols-1 gap-3 w-full" onSubmit={submit}>
      ...
      <button
        class="bg-zinc-100 py-1.5 border border-zinc-100 rounded-md mt-2 text-black font-medium text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6488ea] focus:ring-offset-zinc-900"
        type="submit"
