...
const postFormData = async (formData: SucessForm) => {
    ...
    <form class="grid grid-cols-1 gap-3 w-full" onSubmit={submit}>
      <div class="grid grid-cols-1 gap-2">
        ...
        <input
          ...
          id="email"
          name="email"
          class="rounded-md py-1 px-3 bg-zinc-800 text-zinc-300 border border-zinc-700 focus:border-[#6488ea] focus:outline-none focus:ring-2 focus:ring-[#6488ea] focus:ring-opacity-60 focus:bg-zinc-900"
        />
        <Show
      ...
      <button
        class="bg-zinc-100 py-1.5 border border-zinc-100 rounded-md mt-2 text-zinc-900 font-medium text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#6488ea] disabled:opacity-50 disabled:cursor-not-allowed"
        type="submit"
      ...
      <div>
        <hr class="h-0 border-t mt-4 border-zinc-300"></hr>
        <p class="-mt-2.5 text-xs text-center text-zinc-500">
      ...
      <div class="grid grid-cols-1">
        <button
          ...
          class="bg-zinc-100 p-1.5 border border-zinc-100 flex justify-center items-center gap-2 rounded-md mt-2 text-zinc-900 font-medium text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
          type="button"
        >
          <svg
