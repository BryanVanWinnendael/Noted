...
const NavBar = () => {
  const { getSecondaryBackgroundColor, getBackgroundColor, getAccentColor, getTextColor, getMutedTextColor } =
    useColors()
  ...
  return (
    <Grid
      ...
      top={0}
    >
      <Flex alignItems="center" alignContent="center" pl={2}>
        <MenuBar />
        <SidebarButton />
      </Flex>
      ...
      <Flex>
        <Tooltip placement="bottom" label={"Ctrl+w"} bg={bg_color} color={text_color} rounded="md">
          <Box
