import { Box, Card, Flex, Menu, MenuButton, MenuItem, MenuList, Stack, Text } from '@chakra-ui/react'
...
const ImportCard = ({ path }: { path: string }) => {
  const { getBackgroundColor, getBorderColor, getIconColor, getTextColor } = useColors()
  ...
  return (
    ...
    >
      ...
      >
        <img src={path} alt="imported" className='rounded-[0.375rem] h-full w-full absolute'/>
        { selected && 
