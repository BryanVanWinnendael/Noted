...
*****************************************************************************/
  ...
  $jscomp.polyfillUnisolated = function (e, c, f, a) {
    ...
    c != a &&
      null != c &&
      $jscomp.defineProperty(f, e, { configurable: !0, writable: !0, value: c })
  }
  ...
  $jscomp.setPrototypeOf =
    $jscomp.TRUST_ES6_POLYFILLS && "function" == typeof Object.setPrototypeOf
      ...
      : $jscomp.underscoreProtoCanBeSet()
        ? function (e, c) {
            e.__proto__ = c
            if (e.__proto__ !== c) throw new TypeError(e + " is not extensible")
            return e
          }
        : null
  $jscomp.assign =
          ...
          E.race = function (n) {
            ...
            return new this(function (v, D) {
              for (var L = 0, G; L < n.length; L++)
                (G = n[L]) && "function" === typeof G.then ? G.then(v, D) : v(G)
            })
          }
