    ...
    (n = [
      ...
      function (t, e) {
        ...
        ;(h.Convert =
          ...
          (h.PDFAOptions = function (t) {
            ;(this.name = "PDFAOptions"), (this.id = t)
          }),
          (h.PDFDC = function (t) {
          ...
          (h.PDFDoc.RefreshOptions.prototype.setRefreshExisting = function (t) {
            return this.mHelpers.putBool(this.mImpl, "RefreshExisting", t), this
          }),
          ...
          (h.PDFACompliance.createPDFAOptions = function (t) {
            return Promise.resolve(new h.PDFACompliance.PDFAOptions(t))
          }),
          (h.PDFACompliance.PDFAOptions = function (t) {
            ;(this.name = "PDFNet.PDFACompliance.PDFAOptions"),
              (this.mImpl = {}),
              (this.mHelpers = i()),
              this.setConformance(t)
          }),
          (h.PDFACompliance.PDFAOptions.prototype.getConformance = function () {
            return "Conformance" in this.mImpl
              ? this.mImpl.Conformance
              : h.PDFACompliance.Conformance.e_Level1B
          }),
          (h.PDFACompliance.PDFAOptions.prototype.setConformance = function (
            t,
          ) {
            return this.mHelpers.putNumber(this.mImpl, "Conformance", t), this
          }),
          (h.PDFACompliance.PDFAOptions.prototype.getDPI = function () {
            return "Dpi" in this.mImpl ? 0 | this.mImpl.Dpi : 300
          }),
          (h.PDFACompliance.PDFAOptions.prototype.setDPI = function (t) {
            return this.mHelpers.putNumber(this.mImpl, "Dpi", t), this
          }),
          (h.PDFACompliance.PDFAOptions.prototype.getFirstStop = function () {
            return "FirstStop" in this.mImpl && !!this.mImpl.FirstStop
          }),
          (h.PDFACompliance.PDFAOptions.prototype.setFirstStop = function (t) {
            return this.mHelpers.putBool(this.mImpl, "FirstStop", t), this
          }),
          (h.PDFACompliance.PDFAOptions.prototype.getFlattenTransparency =
            function () {
              return "Flatten" in this.mImpl && !!this.mImpl.Flatten
            }),
          (h.PDFACompliance.PDFAOptions.prototype.setFlattenTransparency =
            function (t) {
              return this.mHelpers.putBool(this.mImpl, "Flatten", t), this
            }),
          (h.PDFACompliance.PDFAOptions.prototype.getMaxRefObjs = function () {
            return "MaxRefObjs" in this.mImpl ? 0 | this.mImpl.MaxRefObjs : 10
          }),
          (h.PDFACompliance.PDFAOptions.prototype.setMaxRefObjs = function (t) {
            return this.mHelpers.putNumber(this.mImpl, "MaxRefObjs", t), this
          }),
          (h.PDFACompliance.PDFAOptions.prototype.getPassword = function () {
            return "Password" in this.mImpl ? this.mImpl.Password : ""
          }),
          (h.PDFACompliance.PDFAOptions.prototype.setPassword = function (t) {
            return this.mHelpers.putString(this.mImpl, "Password", "" + t), this
          }),
          (h.PDFACompliance.PDFAOptions.prototype.getJsonString = function () {
            return JSON.stringify(this.mImpl)
          }),
          ...
          (h.PDFACompliance.createFromFileWithOptions = function (t, e, n) {
            return (
              void 0 === n && (n = null),
              f(
                arguments.length,
              ...
              F("createFromFileWithOptions", [[n, 2]]),
              (n = n ? n.getJsonString() : "{}"),
              h
                ...
                .then(function (t) {
                  return D(h.PDFACompliance, t)
                })
            )
          }),
          (h.PDFACompliance.createFromBufferWithOptions = function (t, e, n) {
            void 0 === n && (n = null),
              f(
                arguments.length,
                2,
              ...
              F("createFromBufferWithOptions", [[n, 2]])
            var i = b(e, !1)
            return (
              (n = n ? n.getJsonString() : "{}"),
              h
        ...
        ;(h.ClassMap.prototype.copy = function () {
          ...
          (h.CaretAnnot.prototype.getSymbol = function () {
            return h.sendWithPromise("CaretAnnot.getSymbol", { caret: this.id })
          }),
          ...
          (h.LineAnnot.prototype.getEndPoint = function () {
            return h.sendWithPromise("LineAnnot.getEndPoint", { line: this.id })
          }),
          ...
          (h.LineAnnot.prototype.getEndStyle = function () {
            return h.sendWithPromise("LineAnnot.getEndStyle", { line: this.id })
          }),
          ...
          (h.ScreenAnnot.prototype.getScaleType = function () {
            return h.sendWithPromise("ScreenAnnot.getScaleType", { s: this.id })
          }),
          ...
          (h.TextAnnot.prototype.getIconName = function () {
            return h.sendWithPromise("TextAnnot.getIconName", { text: this.id })
          }),
          ...
          (h.Date.prototype.setUT = function (t) {
            f(arguments.length, 1, "setUT", "(number)", [[t, "number"]]),
              P("setUT", this.yieldFunction)
            var e = this
            return (
          ...
          (h.Date.prototype.setUTHour = function (t) {
            f(arguments.length, 1, "setUTHour", "(number)", [[t, "number"]]),
              P("setUTHour", this.yieldFunction)
            var e = this
            return (
          ...
          (h.Date.prototype.setUTMinutes = function (t) {
            f(arguments.length, 1, "setUTMinutes", "(number)", [[t, "number"]]),
              P("setUTMinutes", this.yieldFunction)
            var e = this
            return (
          ...
          (h.GState.prototype.getStrokeOpacity = function () {
            return h.sendWithPromise("GState.getStrokeOpacity", { gs: this.id })
          }),
          ...
          (h.GState.prototype.getFillOverprint = function () {
            return h.sendWithPromise("GState.getFillOverprint", { gs: this.id })
          }),
          (h.GState.prototype.getOverprintMode = function () {
            return h.sendWithPromise("GState.getOverprintMode", { gs: this.id })
          }),
          ...
          (h.Element.prototype.getImageDataSize = function () {
            return h.sendWithPromise("Element.getImageDataSize", { e: this.id })
          }),
          ...
          (h.Element.prototype.getPosAdjustment = function () {
            return h.sendWithPromise("Element.getPosAdjustment", { e: this.id })
          }),
        ...
        ;(h.Element.prototype.getMCPropertyDict = function () {
          ...
          (h.ElementBuilder.prototype.createTextBeginWithFont = function (
            t,
            e,
          ) {
            return (
          ...
          (h.ElementBuilder.prototype.pathBegin = function () {
            return h.sendWithPromise("ElementBuilder.pathBegin", { b: this.id })
          }),
          ...
          (h.ElementBuilder.prototype.closePath = function () {
            return h.sendWithPromise("ElementBuilder.closePath", { b: this.id })
          }),
          ...
          (h.Font.prototype.isHorizontalMode = function () {
            return h.sendWithPromise("Font.isHorizontalMode", { font: this.id })
          }),
          ...
          (h.Image.prototype.getImageDataSize = function () {
            return h.sendWithPromise("Image.getImageDataSize", { img: this.id })
          }),
          ...
          (h.PDFDoc.prototype.hasRepairedXRef = function () {
            return h.sendWithPromise("PDFDoc.hasRepairedXRef", { doc: this.id })
          }),
          ...
          (h.PDFDocInfo.prototype.getSubject = function () {
            return h.sendWithPromise("PDFDocInfo.getSubject", { info: this.id })
          }),
          ...
          (h.PDFDocInfo.prototype.getCreator = function () {
            return h.sendWithPromise("PDFDocInfo.getCreator", { info: this.id })
          }),
          ...
          (h.PDFRasterizer.prototype.setThinLineScaling = function (t) {
            return (
              f(arguments.length, 1, "setThinLineScaling", "(number)", [
                [t, "number"],
              ]),
              h.sendWithPromise("PDFRasterizer.setThinLineScaling", {
                r: this.id,
                scaling: t,
              })
            )
          ...
          (h.PDFDraw.prototype.setThinLineScaling = function (t) {
            return (
              f(arguments.length, 1, "setThinLineScaling", "(number)", [
                [t, "number"],
              ]),
              h.sendWithPromise("PDFDraw.setThinLineScaling", {
                d: this.id,
                scaling: t,
              })
            )
          ...
          (h.SDFDoc.prototype.hasRepairedXRef = function () {
            return h.sendWithPromise("SDFDoc.hasRepairedXRef", { doc: this.id })
          }),
          ...
          (h.SDFDoc.prototype.tryLockRead = function () {
            ...
            return h
              ...
              .then(function (t) {
                t &&
                  o.push({ name: "SDFDoc", id: e.id, unlocktype: "unlockRead" })
              })
          }),
        ...
        ;(h.DocSnapshot.prototype.getHash = function () {
          ...
          (h.VerificationOptions.prototype.getTrustedCertificateCount =
            function () {
              return h.sendWithPromise(
          ...
          (h.VerificationOptions.prototype.getTrustedCertificate = function (
            t,
          ) {
            return (
              f(arguments.length, 1, "getTrustedCertificate", "(number)", [
                [t, "number"],
              ]),
              h
          ...
          (h.WebFontDownloader.selectWebFont = function (t, e) {
            return (
              f(arguments.length, 2, "selectWebFont", "(string, string)", [
                [t, "string"],
                [e, "string"],
              ]),
              h.sendWithPromise("webFontDownloaderSelectWebFont", {
                font_req_string: t,
                charset: e,
              })
            )
          ...
          (h.ListItem.prototype.getItemIndex = function () {
            return h.sendWithPromise("ListItem.getItemIndex", { self: this.id })
          }),
        ...
        var g,
          ...
          T = h.PDFDoc.prototype.saveStream
        ;(h.PDFDoc.prototype.saveMemoryBuffer = function (t) {
          var e = this
          ...
          (h.runWithCleanup = function (t, e) {
            ...
            return (A = A.then(
              ...
              .catch(function (t) {
                throw (r && h.endDeallocateStack(), i && h.finishOperation(), t)
              }))
          }),
