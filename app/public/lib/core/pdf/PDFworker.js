...
*****************************************************************************/
  ...
  $jscomp.polyfillUnisolated = function (v, z, u, q) {
    ...
    z != q &&
      null != z &&
      $jscomp.defineProperty(u, v, { configurable: !0, writable: !0, value: z })
  }
      ...
      v = (function () {
        ...
        B.prototype.postMessage = function (m) {
          "officeeditor" !== this.name &&
            ...
            Object(q.d)(
              "PDFWorker",
              performance.now() + " Sent " + JSON.stringify(m),
            )
        ...
        B.prototype.handleMessage = function (m) {
          ...
          "officeeditor" !== this.name &&
            ...
            Object(q.d)(
              "PDFWorker",
              performance.now() + " Received " + JSON.stringify(k),
            )
          var p = this.actionHandler,
                ...
                f.XFDFMerge = function (l, g, x) {
                  if (g) {
                    ...
                    try {
                      ...
                      H &&
                        H.length &&
                        Module.postEvent(l, "apRefChanged", { apRefChanges: H })
                    } finally {
