;(function () {
  ...
  $jscomp.polyfillUnisolated = function (p, l, q, n) {
    ...
    l != n &&
      null != l &&
      $jscomp.defineProperty(q, p, { configurable: !0, writable: !0, value: l })
  }
        ...
        y.prototype = {
          ...
          downloadChunk: function (b, c) {
            ...
            if (h) {
              ...
              this.withCredentials && (f.withCredentials = this.withCredentials)
              ...
              f.onload = function () {
                if (200 === f.status || 206 === f.status) {
                  ...
                  window.parent.parentWarn("Failed to load data from" + a.url),
                    (e = new Int8Array(0))
                for (var u = a.chunkReader[b], x = 0; x < u.length; x++) u[x](e)
