  ...
  ;(function (modules) {
    ...
    function (module, exports$jscomp$0) {
      ...
      ;(function (exports) {
        ...
        PDFNet.PDFACompliance.PDFAOptions.prototype.getConformance =
          function () {
            return "Conformance" in this.mImpl
              ? this.mImpl.Conformance
              : PDFNet.PDFACompliance.Conformance.e_Level1B
          }
        PDFNet.PDFACompliance.PDFAOptions.prototype.setConformance = function (
          value,
        ) {
        ...
        PDFNet.PDFACompliance.PDFAOptions.prototype.setFirstStop = function (
          value,
        ) {
          this.mHelpers.putBool(this.mImpl, "FirstStop", value)
          return this
        }
        PDFNet.PDFACompliance.PDFAOptions.prototype.getFlattenTransparency =
          function () {
            return "Flatten" in this.mImpl ? !!this.mImpl.Flatten : !1
          }
        PDFNet.PDFACompliance.PDFAOptions.prototype.setFlattenTransparency =
          function (value) {
            this.mHelpers.putBool(this.mImpl, "Flatten", value)
            return this
          }
        PDFNet.PDFACompliance.PDFAOptions.prototype.getMaxRefObjs =
          function () {
            return "MaxRefObjs" in this.mImpl ? 0 | this.mImpl.MaxRefObjs : 10
          }
        PDFNet.PDFACompliance.PDFAOptions.prototype.setMaxRefObjs = function (
          value,
        ) {
        ...
        PDFNet.PDFACompliance.PDFAOptions.prototype.setPassword = function (
          value,
        ) {
          this.mHelpers.putString(this.mImpl, "Password", "" + value)
          return this
        }
        PDFNet.PDFACompliance.PDFAOptions.prototype.getJsonString =
          function () {
            return JSON.stringify(this.mImpl)
          }
        ...
        PDFNet.Matrix2D.prototype.equals = function (m2) {
          ...
          return PDFNet.sendWithPromise("Matrix2D.equals", { m1: this, m2: m2 })
        }
        ...
        PDFNet.Field.prototype.getValueAsBool = function () {
          ...
          return PDFNet.sendWithPromise("Field.getValueAsBool", { field: this })
        }
        ...
        PDFNet.Field.prototype.getPartialName = function () {
          ...
          return PDFNet.sendWithPromise("Field.getPartialName", { field: this })
        }
        ...
        PDFNet.FilterReader.prototype.get = function () {
          return PDFNet.sendWithPromise("FilterReader.get", { reader: this.id })
        }
        ...
        PDFNet.PDFACompliance.createFromFileWithOptions = function (
          convert,
          file_path,
          in_options,
        ) {
          ...
          checkArguments(
            ...
            [
              [convert, "boolean"],
              [file_path, "string"],
              [in_options, "OptionBase"],
            ],
          )
          checkParamsYieldFunction("createFromFileWithOptions", [
            [in_options, 2],
          ])
          in_options = in_options ? in_options.getJsonString() : "{}"
          return PDFNet.sendWithPromise(
            "pdfaComplianceCreateFromFileWithOptions",
            { convert: convert, file_path: file_path, in_options: in_options },
          ).then(function (id) {
            return createDestroyableObj(PDFNet.PDFACompliance, id)
          })
        }
        PDFNet.PDFACompliance.createFromBufferWithOptions = function (
          convert,
          buf,
          in_options,
        ) {
          ...
          checkParamsYieldFunction("createFromBufferWithOptions", [
            [in_options, 2],
          ])
          var bufArrayBuffer = getArrayBuffer(buf, !1)
          in_options = in_options ? in_options.getJsonString() : "{}"
          return PDFNet.sendWithPromise(
            "pdfaComplianceCreateFromBufferWithOptions",
            { convert: convert, buf: bufArrayBuffer, in_options: in_options },
          ).then(function (id) {
            return createDestroyableObj(PDFNet.PDFACompliance, id)
          })
        }
        ...
        PDFNet.Page.prototype.hasTransition = function () {
          return PDFNet.sendWithPromise("Page.hasTransition", { page: this.id })
        }
        ...
        PDFNet.Annot.prototype.getContents = function () {
          return PDFNet.sendWithPromise("Annot.getContents", { annot: this.id })
        }
        ...
        PDFNet.Annot.prototype.getRotation = function () {
          return PDFNet.sendWithPromise("Annot.getRotation", { annot: this.id })
        }
        ...
        PDFNet.PopupAnnot.prototype.isOpen = function () {
          return PDFNet.sendWithPromise("PopupAnnot.isOpen", { popup: this.id })
        }
        ...
        PDFNet.TextAnnot.prototype.getState = function () {
          return PDFNet.sendWithPromise("TextAnnot.getState", { text: this.id })
        }
        ...
        PDFNet.Bookmark.prototype.hasChildren = function () {
          return PDFNet.sendWithPromise("Bookmark.hasChildren", { bm: this.id })
        }
        ...
        PDFNet.Date.prototype.setUT = function (ut) {
          checkArguments(arguments.length, 1, "setUT", "(number)", [
            [ut, "number"],
          ])
          checkThisYieldFunction("setUT", this.yieldFunction)
          var me = this
          this.yieldFunction = "Date.setUT"
          return PDFNet.sendWithPromise("Date.setUT", {
            date: this,
            ut: ut,
          }).then(function (id) {
            me.yieldFunction = void 0
        ...
        PDFNet.Date.prototype.setUTHour = function (ut_hour) {
          checkArguments(arguments.length, 1, "setUTHour", "(number)", [
            [ut_hour, "number"],
          ])
          checkThisYieldFunction("setUTHour", this.yieldFunction)
          var me = this
          this.yieldFunction = "Date.setUTHour"
          return PDFNet.sendWithPromise("Date.setUTHour", {
            date: this,
            ut_hour: ut_hour,
          }).then(function (id) {
            me.yieldFunction = void 0
        ...
        PDFNet.Date.prototype.setUTMinutes = function (ut_minutes) {
          checkArguments(arguments.length, 1, "setUTMinutes", "(number)", [
            [ut_minutes, "number"],
          ])
          checkThisYieldFunction("setUTMinutes", this.yieldFunction)
          var me = this
          this.yieldFunction = "Date.setUTMinutes"
          return PDFNet.sendWithPromise("Date.setUTMinutes", {
            date: this,
            ut_minutes: ut_minutes,
          }).then(function (id) {
            me.yieldFunction = void 0
        ...
        PDFNet.GState.prototype.getMiterLimit = function () {
          return PDFNet.sendWithPromise("GState.getMiterLimit", { gs: this.id })
        }
        ...
        PDFNet.Element.prototype.getStructMCID = function () {
          return PDFNet.sendWithPromise("Element.getStructMCID", { e: this.id })
        }
        ...
        PDFNet.Element.prototype.isWindingFill = function () {
          return PDFNet.sendWithPromise("Element.isWindingFill", { e: this.id })
        }
        ...
        PDFNet.Element.prototype.getImageWidth = function () {
          return PDFNet.sendWithPromise("Element.getImageWidth", { e: this.id })
        }
        ...
        PDFNet.Element.prototype.getTextString = function () {
          return PDFNet.sendWithPromise("Element.getTextString", { e: this.id })
        }
        ...
        PDFNet.Element.prototype.getTextLength = function () {
          return PDFNet.sendWithPromise("Element.getTextLength", { e: this.id })
        }
        ...
        PDFNet.Element.prototype.hasTextMatrix = function () {
          return PDFNet.sendWithPromise("Element.hasTextMatrix", { e: this.id })
        }
        ...
        PDFNet.ShapedText.prototype.getText = function () {
          return PDFNet.sendWithPromise("ShapedText.getText", { self: this.id })
        }
        ...
        PDFNet.FileSpec.prototype.getFilePath = function () {
          return PDFNet.sendWithPromise("FileSpec.getFilePath", { fs: this.id })
        }
        ...
        PDFNet.Font.prototype.getFamilyName = function () {
          return PDFNet.sendWithPromise("Font.getFamilyName", { font: this.id })
        }
        ...
        PDFNet.Font.prototype.getUnitsPerEm = function () {
          return PDFNet.sendWithPromise("Font.getUnitsPerEm", { font: this.id })
        }
        ...
        PDFNet.Highlights.prototype.hasNext = function () {
          return PDFNet.sendWithPromise("Highlights.hasNext", { hlts: this.id })
        }
        ...
        PDFNet.Image.prototype.getImageWidth = function () {
          return PDFNet.sendWithPromise("Image.getImageWidth", { img: this.id })
        }
        ...
        PDFNet.PatternColor.prototype.getType = function () {
          return PDFNet.sendWithPromise("PatternColor.getType", { pc: this.id })
        }
        ...
        PDFNet.PDFDoc.prototype.isLinearized = function () {
          return PDFNet.sendWithPromise("PDFDoc.isLinearized", { doc: this.id })
        }
        ...
        PDFNet.PDFDoc.prototype.getPageCount = function () {
          return PDFNet.sendWithPromise("PDFDoc.getPageCount", { doc: this.id })
        }
        ...
        PDFNet.Shading.prototype.hasBackground = function () {
          return PDFNet.sendWithPromise("Shading.hasBackground", { s: this.id })
        }
        ...
        PDFNet.Shading.prototype.getParamStart = function () {
          return PDFNet.sendWithPromise("Shading.getParamStart", { s: this.id })
        }
        ...
        PDFNet.Shading.prototype.isExtendStart = function () {
          return PDFNet.sendWithPromise("Shading.isExtendStart", { s: this.id })
        }
        ...
        PDFNet.NumberTree.prototype.isValid = function () {
          return PDFNet.sendWithPromise("NumberTree.isValid", { tree: this.id })
        }
        ...
        PDFNet.Obj.prototype.putNull = function (key) {
          ...
          return PDFNet.sendWithPromise("Obj.putNull", { o: this.id, key: key })
        }
        ...
        PDFNet.Obj.prototype.eraseAt = function (pos) {
          ...
          return PDFNet.sendWithPromise("Obj.eraseAt", { o: this.id, pos: pos })
        }
        ...
        PDFNet.SDFDoc.prototype.isLinearized = function () {
          return PDFNet.sendWithPromise("SDFDoc.isLinearized", { doc: this.id })
        }
        ...
        PDFNet.VerificationOptions.prototype.getTrustedCertificateCount =
          function () {
            return PDFNet.sendWithPromise(
        ...
        PDFNet.VerificationOptions.prototype.getTrustedCertificate = function (
          index,
        ) {
          checkArguments(
            arguments.length,
          ...
          return PDFNet.sendWithPromise(
            "VerificationOptions.getTrustedCertificate",
            { self: this.id, index: index },
          ).then(function (id) {
            return createDestroyableObj(PDFNet.X509Certificate, id)
          })
        }
        ...
        PDFNet.WebFontDownloader.selectWebFont = function (
          font_req_string,
          charset,
        ) {
          checkArguments(
          ...
          return PDFNet.sendWithPromise("webFontDownloaderSelectWebFont", {
            font_req_string: font_req_string,
            charset: charset,
          })
        }
        ...
        PDFNet.TableCell.prototype.getWidth = function () {
          return PDFNet.sendWithPromise("TableCell.getWidth", { self: this.id })
        }
