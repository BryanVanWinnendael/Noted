      ...
      var S = "filterAnnotModal",
        j = function () {
          var t = O(
            ...
            R = I[0],
            C = I[1],
            D = O(Object(o.useState)([]), 2),
            U = D[0],
            B = D[1],
            V = O(Object(o.useState)([]), 2),
            P = V[0],
            z = V[1],
            ...
            At = function () {
              var t = function (t) {
                ...
                if (K.length > 0) {
                  ...
                  if (j && r) {
                    var l = Object(g.g)(t)
                    n = K.includes(l)
                  } else n = K.includes(Object(x.a)(t))
                }
                if (
                  J.length > 0 &&
                  !(o = J.includes(c.a.getDisplayAuthor(t.Author, e))) &&
                  nt
                ) {
                  var d,
                    s = t.getReplies(),
              ...
              it
                ...
                Object(u.a)(h.a.ANNOTATION_FILTER_CHANGED, {
                  types: K,
                  authors: J,
                  colors: Z,
                  statuses: dt,
            ...
            Object(o.useEffect)(
              function () {
                ...
                return (
                  n.forEach(function (t) {
                    ...
                    if (
                      ...
                      if (j && n) {
                        var l = Object(g.g)(t)
                        a.add(l)
                      } else a.add(Object(x.a)(t))
                      var d = ht(t)
                      d &&
                        !gt(M(i), d) &&
                        i.add(Object(y.e)(d.R, d.G, d.B, d.A)),
                  ...
                  z(M(i)),
                  W(M(r)),
                  c.a.addEventListener("documentUnloaded", xt),
                  function () {
                    c.a.removeEventListener("documentUnloaded", xt)
                  }
                )
              },
              [n, j],
          ...
          var vt = r()({ Modal: !0, FilterAnnotModal: !0, open: n, closed: !n })
          return e
            ? null
            : a.a.createElement(
                "div",
