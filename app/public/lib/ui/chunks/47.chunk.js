  ...
  [47],
  {
    ...
    1837: function (t, e, n) {
      ...
      var D = {
        ...
        U = "isUnderlined",
        q =
          (I((r = {}), "location", D.CENTER),
          I(r, z, 48),
          I(r, V, ""),
          I(r, G, new window.Core.Annotations.Color(228, 66, 52)),
          I(r, B, 100),
          I(r, H, k[0]),
          I(r, Y, !1),
          I(r, Q, !1),
          ...
          r),
        J =
          (I((o = {}), D.CENTER, "diagonal"),
          I(o, D.TOP_LEFT, "headerLeft"),
          I(o, D.TOP_RIGHT, "headerRight"),
          I(o, D.TOP_CENTER, "headerCenter"),
          I(o, D.BOT_LEFT, "footerLeft"),
          I(o, D.BOT_RIGHT, "footerRight"),
          I(o, D.BOT_CENTER, "footerCenter"),
          o),
        K = (function (t) {
          !(function (t, e) {
          ...
          function a(t) {
            ...
            !(function (t, e) {
              ...
              I(_(e), "constructWatermarkOption", function (t) {
                var e = []
                return (
              ...
              I(_(e), "createWatermarks", function () {
                var t = {}
                return (
              ...
              I(_(e), "removeWatermarkCreatedByModal", function () {
                s.a.setWatermark({})
              }),
              I(_(e), "closeModal", function () {
                e.props.modalClosed()
              }),
              I(_(e), "handleInputChange", function (t, n) {
                var r = C({}, e.state.locationSettings),
              ...
              I(_(e), "getCirclePosn", function (t, e) {
                return e * t + y.a
              }),
              I(_(e), "setColorPaletteVisibility", function (t) {
                e.setState({ isColorPaletteVisible: t })
              }),
              I(_(e), "onLocationChanged", function (t) {
                var n = C({}, e.state.locationSettings)
                Object.keys(n).forEach(function (e) {
                  var r = n[e]
                  ;(r = C(C({}, r), {}, { isSelected: t === e })), (n[e] = r)
                }),
                  e.setState({ locationSettings: n }, function () {
                    e.addWatermarks()
                  })
              }),
              I(_(e), "initializeLocationSettings", function () {
                var t = {}
                return (
              ...
              I(_(e), "getKeyByValue", function (t, e) {
                return Object.keys(t).find(function (n) {
                  return t[n] === e
                })
              }),
              I(_(e), "getCurrentSelectedLocation", function () {
                return Object.keys(e.state.locationSettings).find(function (t) {
                  return e.state.locationSettings[t].isSelected
                })
              }),
              I(_(e), "onColorChanged", function (t) {
                var n = e.getCurrentSelectedLocation(),
                  r = e.state.locationSettings[n]
                r[G] = new window.Core.Annotations.Color(t.R, t.G, t.B)
                var o = C({}, e.state.locationSettings)
                r[V] ||
                  Object.keys(D).forEach(function (e) {
                    var n = o[e]
                    n[V] ||
                      (n[G] = new window.Core.Annotations.Color(t.R, t.G, t.B))
                  }),
                          ...
                          i.a.createElement(
                              ...
                              i.a.createElement(
                                ...
                                Object.keys(D).map(function (t) {
                                  return i.a.createElement(
                                    ...
                                    { key: t, value: t },
                                    e(
                                      "option.watermark.locations.".concat(
                                        D[t],
                                      ),
                                    ),
                                  )
                            ...
                            i.a.createElement(
                              ...
                              i.a.createElement("input", {
                                ...
                                value: r[V],
                                onChange: function (e) {
                                  return t.handleInputChange(V, e.target.value)
                                },
                                type: "text",
                              }),
                            ),
                ...
                return new e(function (o, i) {
                  !(function r(o, a, i, c) {
                    ...
                    if ("throw" !== l.type) {
                      var s = l.arg,
                        u = s.value
                      return u && "object" == nt(u) && n.call(u, "__await")
                        ? e.resolve(u.__await).then(
                            function (t) {
                              r("next", t, i, c)
                            },
      ...
      var ct = function () {
        var t = at(
          ...
          N = Object(a.useRef)(),
          A = Object(a.useRef)(),
          _ = at(Object(a.useState)(!1), 2),
          R = _[0],
          I = _[1],
          F = at(Object(a.useState)(-1), 2),
          D = F[0],
          z = F[1],
          V = at(Object(a.useState)([]), 2),
          G = V[0],
          B = V[1],
          H = at(Object(a.useState)(!1), 2),
          Y = H[0],
          Q = H[1],
          U = at(Object(a.useState)(!0), 2),
          q = U[0],
          J = U[1],
          K = at(Object(a.useState)(!1), 2),
          nt = K[0],
          it = K[1],
          ct = at(Object(a.useState)(!1), 2),
          lt = ct[0],
          st = ct[1],
          dt = at(Object(a.useState)(!1), 2),
          ut = dt[0],
          pt = dt[1]
        Object(a.useEffect)(
          function () {
            var t, e, n
            h &&
              (J(null !== (t = h.includeAnnotations) && void 0 !== t ? t : q),
              it(null !== (e = h.includeComments) && void 0 !== e ? e : nt),
              st(
        ...
        var mt = D >= 0,
          ...
          ht = i.a.createElement(
            i.a.Fragment,
            null,
            C("option.print.specifyPages"),
            i.a.createElement("input", {
              ref: M,
              hidden: !j.current || (j.current && !j.current.checked),
              type: "text",
              placeholder: C("message.customPrintPlaceholder"),
              "aria-label": C("message.customPrintPlaceholder"),
              onChange: yt,
              disabled: mt,
            }),
          )
        Object(a.useEffect)(function () {
          return (
            ...
            s.a.getWatermark().then(function (t) {
              I(null == t || 0 === Object.keys(t).length), (A.current = t)
            }),
            function () {
              s.a.setWatermark(A.current), Q(!1)
            }
          )
        }, [])
        var yt = function () {
            var t = []
            if (W.current.checked)
              ...
              var r = M.current.value.replace(/\s+/g, "")
              t = Object(d.a)(r, y)
            } else N.current.checked && (t = [o])
            B(t)
          },
          bt = function (t) {
            var e
            if ((t.preventDefault(), !(G.length < 1))) {
              z(0), R ? s.a.setWatermark(k) : s.a.setWatermark(A.current)
              var n = Object(p.b)(
                G,
                nt,
                q,
                ...
                w,
                void 0,
                null === (e = N.current) || void 0 === e ? void 0 : e.checked,
                x,
                !1,
                ut,
                O,
          ...
          gt = function () {
            z(-1), S(c.a.closeElement(et.a.PRINT_MODAL))
          },
          vt = function (t) {
            Q(t)
          }
          ...
          : i.a.createElement(
              ...
              i.a.createElement($, {
                ...
                formSubmitted: function (t) {
                  return S(c.a.setWatermarkModalOptions(t))
                },
              }),
              i.a.createElement(
                "div",
                ...
                i.a.createElement(
                  ...
                  i.a.createElement(
                    ...
                    i.a.createElement(
                      ...
                      i.a.createElement(
                        ...
                        i.a.createElement(X.a, {
                          ...
                          id: "include-comments",
                          name: "comments",
                          label: C("option.print.includeComments"),
                          onChange: function () {
                        ...
                        i.a.createElement(X.a, {
                          ...
                          name: "annotations",
                          label: C("option.print.includeAnnotations"),
                          disabled: mt,
                          onChange: function () {
                            return J(function (t) {
                              return !t
                        ...
                        i.a.createElement(X.a, {
                          ...
                          id: "print-grayscale",
                          name: "grayscale",
                          label: C("option.print.printGrayscale"),
                          disabled: mt,
                          onChange: function () {
                    ...
                    i.a.createElement(
                      P.a,
                      { className: "section", dataElement: et.a.PRINT_QUALITY },
                      i.a.createElement(
                        "div",
                        { className: "section-label" },
                        "".concat(C("option.print.pageQuality"), ":"),
                      ),
                      i.a.createElement(
                        "label",
                        ...
                        i.a.createElement(
                          ...
                          i.a.createElement(
                            "option",
                            { value: "2" },
                            "".concat(C("option.print.qualityHigh")),
                          ),
                          i.a.createElement(
                            "option",
                            { value: "1" },
                            "".concat(C("option.print.qualityNormal")),
                          ),
                        ),
                      ),
                      i.a.createElement(
                    ...
                    !r &&
                      i.a.createElement(
                        P.a,
                        {
                          ...
                          dataElement: et.a.PRINT_WATERMARK,
                        },
                        i.a.createElement(
                          "div",
                          { className: "section-label" },
                          C("option.watermark.title"),
                        ),
                        i.a.createElement(
                          "button",
                          {
