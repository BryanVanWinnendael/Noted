  ...
  [49],
  {
    ...
    1460: function (e, t, n) {
      ...
      var g = {
          ...
          defaultLabel: s.a.string,
          pageIndex: s.a.number.isRequired,
          isAdding: s.a.bool,
          isMultiSelectionMode: s.a.bool,
          setSelected: s.a.func,
          onSave: s.a.func.isRequired,
          onRemove: s.a.func,
          onCancel: s.a.func,
          panelSelector: s.a.string,
        },
        y = function (e) {
          var t = e.text,
            n = e.label,
            ...
            S = x[0],
            O = x[1],
            A = f(Object(o.useState)(!1), 2),
            C = A[0],
            N = A[1],
            B = f(Object(o.useState)(t), 2),
            T = B[0],
            j = B[1],
            I = f(Object(o.useState)(!1), 2),
            R = I[0],
            P = I[1],
            M = f(Object(o.useState)(void 0), 2),
            _ = M[0],
            D = M[1],
            K = Object(o.useRef)(),
            L = function () {
            ...
            H = function () {
              O(!1), g("" === T.trim() ? v("message.untitled") : T)
            },
            U = function () {
              O(!1), S && j(t), m && E()
            },
            W = function (e) {
              u.a.setCurrentPage(e + 1)
            }
          return (
            Object(o.useEffect)(
              function () {
            ...
            Object(o.useEffect)(
              function () {
                ;(m || S) && (K.current.focus(), K.current.select()),
                  N(!m && !S)
              },
              [S],
            ),
                ...
                (m || S) &&
                  a.a.createElement(
                    ...
                    a.a.createElement("input", {
                      ...
                      placeholder: v("component.bookmarkTitle"),
                      "aria-label": v("action.name"),
                      value: T,
                      onKeyDown: function (e) {
                        "Enter" === e.key &&
                          (e.stopPropagation(), (m || (S && !L())) && H()),
                          "Escape" === e.key && U()
                      },
                      onChange: function (e) {
      ...
      var N = function (e) {
        var t,
          ...
          l = O(
            Object(r.e)(function (e) {
              return [
                x.a.isElementDisabled(e, w.a.BOOKMARK_PANEL),
                x.a.getBookmarks(e),
                x.a.getCurrentPage(e) - 1,
                x.a.getPageLabels(e),
                x.a.isBookmarkIconShortcutVisible(e),
              ]
            }, r.c),
            5,
          ),
          ...
          k = l[3],
          f = l[4],
          h = O(Object(o.useState)(!1), 2),
          g = h[0],
          y = h[1],
          A = O(Object(o.useState)(!1), 2),
          C = A[0],
          N = A[1],
          B = O(Object(o.useState)([]), 2),
          T = B[0],
          j = B[1],
          I = O(Object(i.a)(), 1)[0],
          R = Object(r.d)()
        Object(o.useEffect)(
          function () {
            f && !c
              ? u.a.setBookmarkIconShortcutVisibility(!0)
              : u.a.setBookmarkIconShortcutVisibility(!1)
          },
          [c, f],
        )
        ...
        var M = function (e) {
          var t = I("warning.deleteBookmark.title"),
            n = {
              message: I("warning.deleteBookmark.message"),
              title: t,
              onConfirm: function () {
                e.forEach(function (e) {
                  return R(v.a.removeBookmark(e))
                }),
                  j([])
              },
              confirmBtnText: I("action.delete"),
            }
          R(v.a.showWarningMessage(n))
        }
        return c
          ? null
          : a.a.createElement(
              "div",
              {
                ...
                "data-element": w.a.BOOKMARK_PANEL,
              },
              a.a.createElement(
                "div",
                ...
                a.a.createElement(
                  ...
                  I("component.bookmarksPanel"),
                ),
                !C &&
                  a.a.createElement(d.a, {
                    className: "bookmark-outline-control-button",
                    dataElement: w.a.BOOKMARK_MULTI_SELECT,
                    label: I("action.edit"),
                    disabled: g || 0 === P.length,
                    onClick: function () {
                      return N(!0)
                    },
                  }),
                C &&
                  a.a.createElement(d.a, {
                    className: "bookmark-outline-control-button",
                    dataElement: w.a.BOOKMARK_MULTI_SELECT,
                    label: I("option.bookmarkOutlineControls.done"),
                    disabled: g,
                    onClick: function () {
                      N(!1), j([])
                    },
              ...
              a.a.createElement(p.a, {
                dataElement: w.a.BOOKMARK_SHORTCUT_OPTION,
                type: "checkbox",
                isSwitch: !0,
                id: "bookmark-view-option",
                className: "bookmark-switch",
                label: I("message.viewBookmark"),
                checked: f,
                onChange: function (e) {
                  return R(
                    v.a.setBookmarkIconShortcutVisibility(e.target.checked),
                  )
                },
              }),
              !g &&
              ...
              a.a.createElement(
                ...
                g &&
                  a.a.createElement(E, {
                    isAdding: !0,
                    label: ""
                      .concat(I("component.bookmarkPage"), " ")
                      .concat(k[s], " - ")
                      .concat(I("component.bookmarkTitle")),
                    text: null !== (t = m[s]) && void 0 !== t ? t : "",
                    pageIndex: s,
                    onSave: function (e) {
                      R(v.a.addBookmark(s, e)), y(!1)
                    },
                    onCancel: function () {
                      return y(!1)
                    },
              ...
              a.a.createElement(
                b.a,
                {
                  ...
                  dataElement: w.a.BOOKMARK_ADD_NEW_BUTTON_CONTAINER,
                },
                C
                  ? a.a.createElement(
                      a.a.Fragment,
                  ...
                  : a.a.createElement(d.a, {
                      ...
                      img: "icon-menu-add",
                      dataElement: w.a.BOOKMARK_ADD_NEW_BUTTON,
                      label: ""
                        .concat(I("action.add"), " ")
                        .concat(I("component.bookmarkPanel")),
                      disabled: g || !!m[s],
                      onClick: function () {
                        return y(!0)
                      },
