        ...
        insert: function (t) {
          ...
          for (let n = 0; n < e.length; n++) {
            ...
            if (0 === n)
              ...
              o.shadowRoot.appendChild(e), r.push(e)
            }
          }
        },
        singleton: !1,
    ...
    1840: function (t, e, r) {
      ...
      function b() {
        ...
        function u(t, e, r, o) {
          var i = e && e.prototype instanceof s ? e : s,
            ...
            l = new k(o || [])
          return n(a, "_invoke", { value: D(t, r, l) }), a
        }
        function d(t, e, r) {
          try {
        ...
        var g = (m.prototype = s.prototype = Object.create(y))
        function x(t) {
                ...
                return new e(function (o, a) {
                  !(function n(o, i, a, l) {
                    ...
                    if ("throw" !== c.type) {
                      var u = c.arg,
                        p = u.value
                      return p && "object" == h(p) && r.call(p, "__await")
      ...
      var O = function (t) {
        var e = t.fileInput,
          ...
          D = t.isOpen,
          O = M(Object(p.a)(), 1)[0],
          E = M(Object(n.useState)("url"), 2),
          j = E[0],
          k = E[1],
          S = M(Object(n.useState)(""), 2),
          A = S[0],
          L = S[1],
          P = o.a.createRef(),
          _ = o.a.createRef(),
          N = function t(e) {
            var r = new window.Core.Annotations.Model3DAnnotation()
            r.set3DData(A), "url" === j && r.set3DData(h, "url")
            var n = l.a.getZoom()
            ;(r.X = e.layerX / n),
              (r.Y = e.layerY / n),
              (r.Width = 300),
              (r.Height = 300),
              (r.Author = l.a.getCurrentUser()),
              r.setPageNumber(l.a.getCurrentPage()),
              l.a.addAnnotations([r]),
              l.a.drawAnnotationsFromList([r]),
      ...
      var G = function (t) {
        var e = Object(c.d)(),
          r = F(Object(n.useState)(""), 2),
          u = r[0],
          d = r[1],
          p = F(Object(n.useState)({}), 2),
          s = p[0],
          f = p[1],
          m = F(Object(n.useState)({ fileError: "", urlError: "" }), 2),
          h = m[0],
          b = m[1],
          y = o.a.createRef(),
          v = o.a.createRef(),
