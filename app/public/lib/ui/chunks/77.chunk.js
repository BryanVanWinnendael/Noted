    ...
    1852: function (e, t, a) {
      ...
      var T = function () {
        var e,
          ...
          V = n[8],
          B = u < 1e3,
          D = c.a.getDocumentViewer(),
          j = null == D ? void 0 : D.getDisplayModeManager()
        j && j.isVirtualDisplayEnabled() && (B = !0)
        var S,
          L,
          I = !b.g && !M && V,
          F = function (e, t) {
        ...
        R && ((S = R.pageTransition), (L = R.layout))
        var _ =
          ...
          !h &&
            s.a.createElement(
              ...
              s.a.createElement(
                E.a,
                {
                  className: i()({ row: !0, active: "single" === L }),
                  onClick: function () {
                    return F(S, "single")
                  },
              ...
              s.a.createElement(
                E.a,
                {
                  className: i()({ row: !0, active: "double" === L }),
                  onClick: function () {
                    return F(S, "double")
                  },
              ...
              s.a.createElement(
                E.a,
                {
                  className: i()({ row: !0, active: "cover" === L }),
                  onClick: function () {
                    return F(S, "cover")
                  },
            ...
            : s.a.createElement(
                ...
                s.a.createElement(
                  ...
                  s.a.createElement(
                    "div",
                    { className: "title" },
                    t(O ? "action.exitFullscreen" : "action.enterFullscreen"),
                  ),
                ),
              ),
        )
