    ...
    1856: function (t, e, n) {
      ...
      function T() {
                ...
                return new e(function (i, a) {
                  !(function o(i, r, a, c) {
                    ...
                    if ("throw" !== l.type) {
                      var u = l.arg,
                        p = u.value
                      return p && "object" == C(p) && n.call(p, "__await")
        ...
        return (
          ...
          b(v.prototype),
          l(v.prototype, a, function () {
            return this
          }),
          (t.AsyncIterator = v),
          (t.async = function (e, n, o, i, r) {
            void 0 === r && (r = Promise)
            var a = new v(u(e, n, o, i), r)
      ...
      var A = function (t) {
          ...
          return i.a.createElement(
            "div",
            {
              className: a()("office-action-item", { disabled: f }),
              onClick: function () {
                return !f && n()
              },
              tabIndex: f ? -1 : 0,
              ...
              onKeyDown: function (t) {
                "Enter" !== t.key ||
                  f ||
                  (n(), h(g.a.closeElement(O.a.CONTEXT_MENU_POPUP)))
              },
            },
            i.a.createElement(
              "div",
              { className: "icon-title" },
              o && i.a.createElement(m.a, { glyph: o, disabled: f }),
              !o && i.a.createElement("span", { className: "Icon" }),
              i.a.createElement("div", null, d(r)),
            ),
          ...
          var e = t.clickPosition,
            n = N(
              Object(u.e)(function (t) {
                return [
                  y.a.isElementOpen(t, O.a.CONTEXT_MENU_POPUP),
                  y.a.isElementDisabled(t, O.a.CONTEXT_MENU_POPUP),
                  y.a.isRightClickAnnotationPopupEnabled(t),
                  y.a.isMultiViewerMode(t),
                  y.a.getActiveDocumentViewerKey(t),
                ]
              }, u.c),
              5,
            ),
            ...
            P = Object(u.d)(),
            k = Object(u.f)(),
            I = N(Object(o.useState)({ left: 0, top: 0 }), 2),
            M = I[0],
            L = I[1],
            R = Object(o.useRef)(),
            S = !!v.m || Object(v.l)()
          if (
            (Object(h.a)(R, function () {
              P(g.a.closeElement(O.a.CONTEXT_MENU_POPUP))
            }),
            Object(o.useEffect)(
              function () {
                r &&
                  P(
                    g.a.closeElements([
                      O.a.ANNOTATION_POPUP,
                      O.a.TEXT_POPUP,
                      O.a.INLINE_COMMENT_POPUP,
                    ]),
                  )
              },
              [r],
            ...
            Object(o.useLayoutEffect)(
              function () {
                var t = e.left,
                  ...
                  r = o.height,
                  a = m
                    ? Object(w.a)().querySelector(
                        "#DocumentContainer".concat(C),
                      )
                    : Object(w.a)().querySelector(".DocumentContainer")
                if (a) {
          ...
          var F = i.a.createElement(
            "div",
            {
              className: a()("Popup", "ContextMenuPopup", {
                open: r,
                closed: !r,
                isOfficeEditor: Object(x.a)(),
                "is-vertical": p && !Object(x.a)(),
                "is-horizontal": !p && !Object(x.a)(),
              }),
              ref: R,
              "data-element": O.a.CONTEXT_MENU_POPUP,
              style: j({}, M),
              onClick: function () {
                return P(g.a.closeElement(O.a.CONTEXT_MENU_POPUP))
              },
            },
            i.a.createElement(
              s.a,
              { locked: r && 0 !== M.top && 0 !== M.left },
              i.a.createElement(
                "div",
                { className: "container" },
                Object(x.a)()
                  ? i.a.createElement(
                      ...
                      i.a.createElement(A, {
                        title: "action.cut",
                        img: "icon-cut",
                        dataElement: O.a.OFFICE_EDITOR_CUT,
                        onClick: _(
                          T().mark(function t() {
                              ...
                              for (;;)
                                switch ((t.prev = t.next)) {
                                  case 0:
                                    return (
                                      (t.next = 2),
                                      b.a.getOfficeEditor().copySelectedText()
                                    )
                                  case 2:
                                    b.a.getOfficeEditor().removeSelection()
                                  case 3:
                                  case "end":
                                    return t.stop()
                                }
                        ...
                        shortcut: "Ctrl+X",
                        disabled: !b.a.getOfficeEditor().isTextSelected(),
                      }),
                      i.a.createElement(A, {
                        title: "action.copy",
                        img: "icon-copy",
                        dataElement: O.a.OFFICE_EDITOR_COPY,
                        onClick: function () {
                          return b.a.getOfficeEditor().copySelectedText()
                        },
                        shortcut: "Ctrl+C",
                        disabled: !b.a.getOfficeEditor().isTextSelected(),
                      }),
                      !v.d &&
                        i.a.createElement(
                          ...
                          i.a.createElement(A, {
                            title: "action.paste",
                            img: "icon-paste",
                            dataElement: O.a.OFFICE_EDITOR_PASTE,
                            onClick: function () {
                              return b.a.getOfficeEditor().pasteText()
                            },
                            shortcut: "Ctrl+V",
                          }),
                          i.a.createElement(A, {
                            ...
                            dataElement:
                              O.a.OFFICE_EDITOR_PASTE_WITHOUT_FORMATTING,
                            onClick: function () {
                              return b.a.getOfficeEditor().pasteText(!1)
                            },
                            shortcut: "Ctrl+Shift+V",
                          }),
                        ),
                      !b.a.getOfficeEditor().isCursorInTable() &&
                        i.a.createElement(A, {
                          title: "action.delete",
                          img: "icon-delete-line",
                          dataElement: O.a.OFFICE_EDITOR_DELETE,
                          onClick: function () {
                            return b.a.getOfficeEditor().removeSelection()
                          },
                          disabled: !(
                            b.a.getOfficeEditor().isTextSelected() ||
                            b.a.getOfficeEditor().isImageSelected()
                          ),
                        }),
                      b.a.getOfficeEditor().isCursorInTable() &&
                        i.a.createElement(
                          ...
                          i.a.createElement(A, {
                            ...
                            dataElement: O.a.OFFICE_EDITOR_INSERT_ROW_ABOVE,
                            onClick: function () {
                              return b.a.getOfficeEditor().insertRows(1, !0)
                            },
                          }),
                          i.a.createElement(A, {
                            title: "officeEditor.insertRowBelow",
                            dataElement: O.a.OFFICE_EDITOR_INSERT_ROW_BELOW,
                            onClick: function () {
                              return b.a.getOfficeEditor().insertRows(1, !1)
                            },
                          }),
                          i.a.createElement(A, {
                            title: "officeEditor.insertColumnRight",
                            dataElement: O.a.OFFICE_EDITOR_INSERT_COLUMN_RIGHT,
                            onClick: function () {
                              return b.a.getOfficeEditor().insertColumns(1, !0)
                            },
                          }),
                          i.a.createElement(A, {
                            title: "officeEditor.insertColumnLeft",
                            dataElement: O.a.OFFICE_EDITOR_INSERT_COLUMN_LEFT,
                            onClick: function () {
                              return b.a.getOfficeEditor().insertColumns(1, !1)
                            },
                          }),
                          i.a.createElement(A, {
                            title: "officeEditor.deleteRow",
                            dataElement: O.a.OFFICE_EDITOR_DELETE_ROW,
                            onClick: function () {
                              return b.a.getOfficeEditor().removeRows()
                            },
                          }),
                          i.a.createElement(A, {
                            title: "officeEditor.deleteColumn",
                            dataElement: O.a.OFFICE_EDITOR_DELETE_COLUMN,
                            onClick: function () {
                              return b.a.getOfficeEditor().removeColumns()
                            },
                          }),
                          i.a.createElement(A, {
                            title: "officeEditor.deleteTable",
                            dataElement: O.a.OFFICE_EDITOR_DELETE_TABLE,
                            onClick: function () {
                              return b.a.getOfficeEditor().removeTable()
                            },
                          }),
                        ),
                    )
                  : i.a.createElement(
                      d.a,
                      {
                        dataElement: O.a.CONTEXT_MENU_POPUP,
                      ...
                      i.a.createElement(f.a, {
                        ...
                        onClick: function () {
                          return Object(E.a)(k, "AnnotationCreateSticky")
                        },
                      }),
                      i.a.createElement(f.a, {
                        className: "main-menu-button",
                        ...
                        onClick: function () {
                          return Object(E.a)(k, "AnnotationCreateTextHighlight")
                        },
                      }),
                      i.a.createElement(f.a, {
                        className: "main-menu-button",
                        ...
                        onClick: function () {
                          return Object(E.a)(k, "AnnotationCreateFreeHand")
                        },
                      }),
                      i.a.createElement(f.a, {
                        className: "main-menu-button",
                      ...
                      i.a.createElement(f.a, {
                        ...
                        onClick: function () {
                          return Object(E.a)(k, "AnnotationCreateFreeText")
                        },
                      }),
                      i.a.createElement(f.a, {
                        className: "main-menu-button",
