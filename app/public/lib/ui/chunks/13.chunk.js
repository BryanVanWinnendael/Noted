      ...
      var r = {
        insert: function (o) {
          ...
          ;(t = document.getElementsByTagName("apryse-webviewer")),
            t.length ||
              (t = (function o(t, e = document) {
                const n = []
                return (
                  e.querySelectorAll(t).forEach((o) => n.push(o)),
                  e.querySelectorAll("*").forEach((e) => {
                    e.shadowRoot && n.push(...o(t, e.shadowRoot))
                  }),
                  n
                )
              })("apryse-webviewer"))
    ...
    1372: function (o, t, e) {
      ...
      function k(o, t) {
        return (
          ...
          (function (o, t) {
            if (!o) return
            if ("string" == typeof o) return m(o, t)
      ...
      var g = {
          type: u.a.oneOf(["bookmark", "outline", "portfolio"]).isRequired,
          anchorButton: u.a.string.isRequired,
          shouldDisplayDeleteButton: u.a.bool,
          onClosePopup: u.a.func.isRequired,
          onRenameClick: u.a.func,
          onSetDestinationClick: u.a.func,
          onDownloadClick: u.a.func,
          onDeleteClick: u.a.func,
          onOpenClick: u.a.func,
        },
        f = function (o) {
          var t = o.type,
            e = o.anchorButton,
            l = o.shouldDisplayDeleteButton,
            u = o.onClosePopup,
            m = o.onRenameClick,
            g = o.onSetDestinationClick,
            f = o.onDownloadClick,
            h = o.onDeleteClick,
            v = o.onOpenClick,
            w = k(Object(r.a)(), 1)[0],
            ...
            y = k(
              Object(n.useState)({ left: -100, right: "auto", top: "auto" }),
              2,
            ),
            C = y[0],
            E = y[1],
            j = function (o) {
              var t = o.children,
                e = o.position,
                n = Object(b.a)().querySelector("#outline-edit-popup-portal")
              return (
                (n.style.position = "absolute"),
                (n.style.top =
                  "auto" === e.top ? e.top : "".concat(e.top, "px")),
                (n.style.left =
                  "auto" === e.left ? e.left : "".concat(e.left, "px")),
                (n.style.right =
                  "auto" === e.right ? e.right : "".concat(e.right, "px")),
                (n.style.zIndex = 999),
                Object(i.createPortal)(t, n)
              )
            }
          Object(n.useEffect)(
            function () {
              var o = Object(s.a)(e, x)
              E(o)
            },
            [e],
          )
          var O = Object(n.useCallback)(function (o) {
            ;(null != x && x.current.contains(o.target)) || u()
          })
          return (
            Object(d.a)(x, O),
            a.a.createElement(
