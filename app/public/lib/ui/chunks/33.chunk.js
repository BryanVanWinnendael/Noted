;(window.webpackJsonp = window.webpackJsonp || []).push([
  [33, 2],
  {
    ...
    1356: function (e, t, n) {
      ...
      function p() {
        ...
        function u(e, t, n, o) {
          var a = t && t.prototype instanceof h ? t : h,
            ...
            l = new A(o || [])
          return r(i, "_invoke", { value: C(e, n, l) }), i
        }
        function s(e, t, n) {
          try {
        ...
        var w = (g.prototype = h.prototype = Object.create(b))
        function x(e) {
      ...
      var x = function (e) {
        ...
        E = function (e, t) {
          if (
            ((s = o.a.getDocument()),
            (d = null == s ? void 0 : s.type),
            c.a.PDF === d ||
              c.a.IMAGE === d ||
              (d === c.a.WEBVIEWER_SERVER && !s.isWebViewerServerDocument()))
          ) {
            var n = t
            ...
            var r,
              a = o.a.getDocumentViewer(),
              i = a.getPageRotations(),
              l = y(e)
            try {
              for (l.s(); !(r = l.n()).done; ) {
                var u = r.value
                a.setRotation(x(i[u], t), u)
              }
            } catch (e) {
              l.e(e)
            } finally {
          ...
          E(e, !1),
            Object(d.a)(
              ""
                ...
                .concat(
                  (o.a.getDocument().getPageRotation(o.a.getCurrentPage()) +
                    90) %
                    360,
                  " degrees",
                ),
        ...
        O = function (e, t, n) {
          o.a.insertBlankPages(e, t, n)
        },
        T = function (e, t, n) {
          o.a.insertBlankPages(
            e.map(function (e) {
              return e + 1
            }),
            t,
        ...
        A = function (e) {
          e(i.a.closeElement(s.a.PAGE_MANIPULATION_OVERLAY)),
            e(i.a.openElement("pageReplacementModal"))
        },
        j = function (e, t) {
          var n = l.a.t("warning.extractPage.message"),
            c = l.a.t("warning.extractPage.title"),
            u = l.a.t("warning.extractPage.confirmBtn"),
            s = l.a.t("warning.extractPage.secondaryBtn"),
            m = ""
              .concat(l.a.t("action.page"), " ")
              .concat(e, " ")
            ...
            h = {
              ...
              onConfirm: function () {
                return Object(r.a)(e).then(function (e) {
                  Object(a.saveAs)(e, "extractedDocument.pdf"),
                    Object(d.a)(m + p)
                })
              },
              secondaryBtnText: s,
              onSecondary: function () {
                Object(r.a)(e).then(function (n) {
                  Object(a.saveAs)(n, "extractedDocument.pdf"),
                    o.a.removePages(e).then(function () {
                      t(i.a.setSelectedPageThumbnails([]))
                    }),
                    Object(d.a)(m)
                })
              },
            }
          t(i.a.showWarningMessage(h))
        },
        S = function (e, t) {
          var n =
            ...
            r = ""
              ...
              .concat(l.a.t("action.deleted"))
          if (n) {
            var a = l.a.t("warning.deletePage.deleteMessage"),
              ...
              s = {
                ...
                confirmBtnText: u,
                onConfirm: function () {
                  return o.a.removePages(e).then(function () {
                    t(i.a.setSelectedPageThumbnails([])),
                      t(i.a.setShiftKeyThumbnailsPivotIndex()),
                      Object(d.a)(r)
                  })
                },
              }
            o.a.getDocumentViewer().getPageCount() === e.length &&
              (s = {
                message: (a = l.a.t(
        ...
        k = function (e) {
          o.a.movePages(e, o.a.getTotalPages() + 1),
            Object(d.a)(
              ""
                .concat(l.a.t("action.page"), " ")
                .concat(e, " ")
        ...
        L = function (e, t) {
          if (0 === e.length) {
            ...
            return t(i.a.showWarningMessage(r)), !0
          }
          return !1
        },
        N = function (e, t) {
        ...
        D = function (e, t) {
          ...
          try {
            for (i.s(); !(n = i.n()).done; ) {
              var l = n.value,
                c = a.getPageInfo(l),
                s = a.getPageRotation(l)
              if (c) {
                var d = void 0,
                  m = void 0
                90 === s || 270 === s
                  ? ((d = c.height), (m = c.width))
                  : ((d = c.width), (m = c.height))
                var p = new window.Core.Annotations.RedactionAnnotation(
                  b(
                    {
                      PageNumber: l,
                      Rect: new window.Core.Annotations.Rect(0, 0, d, m),
                    },
                    t,
                  ),
                )
                ;(p.type = u.c.FULL_PAGE),
                  p.setCustomData("trn-redaction-type", u.c.FULL_PAGE),
                  (p.Author = o.a.getCurrentUser()),
                  r.push(p)
              }
            }
          } catch (e) {
          ...
          return (
            o.a.getAnnotationManager().addAnnotations(r),
            o.a.getAnnotationManager().drawAnnotationsFromList(r),
            r
          )
        },
        _ = (function () {
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      ...
                      return (e.next = 6), a.insertPages(t, r)
                    case 6:
                      return (e.next = 8), a.removePages(l)
                    case 8:
                      e.next = 14
                      break
                    case 10:
                      return (e.next = 12), a.removePages(l)
                    case 12:
                      return (e.next = 14), a.insertPages(t, r, l[0])
                    case 14:
                    case "end":
                      return e.stop()
                  }
    ...
    1459: function (e, t, n) {
      ...
      var C = function (e) {
          ...
          return i.a.createElement(
            "div",
            {
              className: t,
              onClick: function () {
                ;-1 === o.indexOf(n) && r(h.a.setSelectedPageThumbnails([n]))
              },
            },
            i.a.createElement(x.a, {
              dataElement: E.a.PAGE_MANIPULATION_OVERLAY_BUTTON,
              element: E.a.PAGE_MANIPULATION_OVERLAY,
              img: "icon-tool-more",
      ...
      var j = { index: v.a.number.isRequired },
        S = function (e) {
          var t = e.index,
            n = Object(O.a)().t,
            r = T(
              ...
              Object(l.e)(function (e) {
                return [
                  p.a.isElementDisabled(
                    e,
                    E.a.PAGE_MANIPULATION_OVERLAY_BUTTON,
                  ),
                ]
              }),
              1,
            ...
            b =
              u.length > 0
                ...
                : [t + 1]
          b.includes(h) || (b = [h])
          var v = g.a.getDocument(),
            x = null == v ? void 0 : v.type,
            A = x === P.a.XOD,
            j = x === P.a.OFFICE || x === P.a.LEGACY_OFFICE,
            S = {
            ...
            L = f.map(function (e) {
              ...
              return r ? i.a.cloneElement(r, { key: n }) : null
            })
          return r
            ? null
            : A || j || (null != v && v.isWebViewerServerDocument())
              ? i.a.createElement(
                  "div",
                  {
      ...
      var U = function (e) {
        var t = e.index,
          ...
          o = e.shiftKeyThumbnailPivotIndex,
          l = e.onFinishLoading,
          c = e.onLoad,
          u = e.onRemove,
          ...
          p = e.onDragOver,
          h = e.isDraggable,
          b = e.shouldShowControls,
          v = e.thumbnailSize,
          y = e.currentPage,
          w = e.pageLabels,
          x = void 0 === w ? [] : w,
          E = e.selectedPageIndexes,
          C = e.isThumbnailMultiselectEnabled,
          P = e.isReaderModeOrReadOnly,
          O = e.dispatch,
          T = e.actions,
          A = e.isMobile,
          j = e.canLoad,
          S = e.onCancel,
          R = e.isThumbnailSelectingPages,
          H = e.thumbnailSelectionMode,
          G = e.activeDocumentViewerKey,
          U = e.panelSelector,
          W = v ? Number(v) : 150,
          F = B(Object(a.useState)({ width: W, height: W }), 2),
          z = F[0],
          V = F[1],
          q = B(Object(a.useState)(!1), 2),
          Y = q[0],
          K = q[1],
          $ = null,
          X = function () {
            $ = setTimeout(function () {
              var e,
                ...
                o = Object(N.a)().querySelector(
                  ".ThumbnailsPanel.".concat(U, " #pageThumb").concat(t),
                ),
                a = t + 1,
                i = g.a.getRotation(a),
                u = g.a.getDocument(G)
              if (u && u.getPageInfo(a)) {
                var s = u.loadCanvas({
                  pageNumber: a,
                  width: W,
                  height: W,
        ...
        Object(a.useEffect)(function () {
          var e = function (e) {
              var n = e.contentChanged,
                ...
                u = Object.keys(r).some(function (e) {
                  return i === parseInt(e)
                }),
                s = a.includes(i),
                d = g.a.getTotalPages()
              ;(a.length > 0 && t + 1 > d) || ((l || c || u || s) && X())
            },
            n = function () {
              K(!1), X()
            }
        ...
        return (
          (((!ee || 2 === ee) && z.width > z.height) ||
            ((1 === ee || 3 === ee) && z.width < z.height)) &&
            (Z = "rotated"),
          i.a.createElement(
            "div",
            {
              className: d()({ Thumbnail: !0, active: J, selected: n && R }),
            ...
            i.a.createElement(
                ...
                onClick: function (e) {
                  ...
                  if (C && !P) {
                    var r = e.ctrlKey || e.metaKey,
                      ...
                      i = M(E)
                    if (a) {
                      O(T.setThumbnailSelectingPages(!0))
                      var l = o
                      null === l &&
                        ((l = y - 1), O(T.setShiftKeyThumbnailsPivotIndex(l)))
                      var c = Math.min(l, t),
                        u = Math.max(l, t)
                      i = M(
                        new Set(
                          ...
                          (r || n || H === I.a.THUMBNAIL) &&
                            (0 !== E.length || R
                              ? E.includes(t)
                                ...
                                : i.push(t)
                              : i.push(y - 1)),
                          O(T.setShiftKeyThumbnailsPivotIndex(t)))
                        : (i = [t])
                    var s = i[i.length - 1]
                    !R && !a && O(T.setShiftKeyThumbnailsPivotIndex(s)),
                      O(T.setSelectedPageThumbnails(i))
                  } else A() && O(T.closeElement("leftPanel"))
                  setTimeout(function () {
                    ;(n && H !== I.a.THUMBNAIL) || g.a.setCurrentPage(t + 1)
                  }, 0)
                },
              },
              ...
              R &&
                ...
                i.a.createElement(L.a, {
                  className: "checkbox ".concat(Z),
                  checked: E.includes(t),
                }),
            ),
            i.a.createElement("div", { className: "page-label" }, Q),
            !R && J && b && i.a.createElement(k, { index: t }),
          )
        )
      }
      function W() {
      ...
      var V = function (e) {
          ...
          return i.a.createElement(
            ...
            W({}, e, {
              currentPage: n,
              pageLabels: r,
              selectedPageIndexes: o,
              isThumbnailMultiselectEnabled: a,
              isReaderModeOrReadOnly: c || u,
              dispatch: v,
              actions: h.a,
              isMobile: m.l,
              shiftKeyThumbnailPivotIndex: s,
      ...
      var K = function () {
        return i.a.createElement(
          ...
          i.a.createElement(x.a, {
            ...
            element: E.a.THUMBNAILS_CONTROL_MANIPULATE_POPUP_SMALL,
            dataElement: E.a.THUMBNAILS_CONTROL_MANIPULATE_POPUP_SMALL_TRIGGER,
            img: "icon-tool-more",
          }),
        ...
        return r
          ? r.map(function (e, t) {
              var r = e.dataElement,
                ...
                c = r || "".concat(a, "-").concat(t)
              return (
                l ||
                  ("divider" === a &&
                    (l = i.a.createElement("div", { className: "divider" })),
                  "customPageOperation" === a &&
                    (l = i.a.createElement(
                      X,
                      Q({ key: r, pageNumbers: n }, e),
                    ))),
                l ? i.a.cloneElement(l, { key: c }) : null
              )
            })
          : o
      }
      var ee = function (e) {
        ...
        return i.a.createElement(
          ...
          i.a.createElement(
            ...
            i.a.createElement(K, { dataElement: "leftPanelPageTabsMoreSmall" }),
          ),
        )
      }
      var te = function () {
        return i.a.createElement(
          ...
          i.a.createElement(x.a, {
            title: "action.more",
            className: "dropdown-menu",
            element: E.a.THUMBNAILS_CONTROL_MANIPULATE_POPUP,
            dataElement: E.a.THUMBNAILS_CONTROL_MANIPULATE_POPUP_TRIGGER,
            img: "icon-tool-more",
          }),
          i.a.createElement("div", { className: "indicator" }),
        )
      ...
      var ae = function (e) {
        ...
        return i.a.createElement(
          ...
          i.a.createElement(
            oe,
            { pageNumbers: t, multiPageManipulationControlsItems: o },
            i.a.createElement(J, {
              onRotateClockwise: n,
            ...
            i.a.createElement(te, { dataElement: "leftPanelPageTabsMore" }),
          ),
        )
      }
      var ie = function (e) {
      ...
      var fe = function (e) {
        var t,
          ...
          a = pe(
            Object(l.e)(function (e) {
              return [
                ...
                p.a.pageDeletionConfirmationModalEnabled(e),
                p.a.getMultiPageManipulationControlsItems(e),
                p.a.getMultiPageManipulationControlsItemsSmall(e),
                p.a.getMultiPageManipulationControlsItemsLarge(e),
          ...
          x = function () {
            return !Object(y.k)(w, r) && Object(y.o)(w)
          },
          C = function () {
            return !Object(y.k)(w, r) && Object(y.p)(w)
          },
          O = g.a.getDocument(),
          T = null == O ? void 0 : O.type,
          A = T === P.a.XOD,
          j = T === P.a.OFFICE || T === P.a.LEGACY_OFFICE
        if (A || j || (null != O && O.isWebViewerServerDocument()))
          return i.a.createElement(
            "div",
            { className: "PageControlContainer root small" },
            i.a.createElement(J, {
        ...
        var S = t > 290,
          k = {
            onReplace: function () {
              return !Object(y.k)(w, r) && Object(y.m)(r)
            },
            onExtractPages: function () {
              return !Object(y.k)(w, r) && Object(y.e)(w, r)
            },
            onDeletePages: function () {
              return !Object(y.k)(w, r) && Object(y.b)(w, r, s)
            },
            onRotateCounterClockwise: C,
            onRotateClockwise: x,
            onInsert: function () {
              return (
                !Object(y.k)(w, r) &&
                (r(h.a.closeElement(E.a.PAGE_MANIPULATION_OVERLAY)),
                void r(h.a.openElement("insertPageModal")))
              )
            },
            moveToTop: function () {
              return !Object(y.k)(w, r) && Object(y.j)(w)
            },
            moveToBottom: function () {
              return !Object(y.k)(w, r) && Object(y.i)(w)
            },
            pageNumbers: w,
          }
        return t < 190
          ? i.a.createElement(
              ee,
              me({}, k, { multiPageManipulationControlsItemsSmall: f }),
            )
          : S
            ? i.a.createElement(
                se,
                me({}, k, { multiPageManipulationControlsItems: b }),
              )
            : i.a.createElement(
                ae,
                me({}, k, { multiPageManipulationControlsItems: d }),
              )
      }
      n(1440)
      function ge(e, t) {
      ...
      function ve(e, t) {
        for (
          ...
          r[a + 1] === r[a] + 1
            ? (o = null !== o ? o : r[a])
            : null !== o
              ? ((n = "".concat(n).concat(t[o], "-").concat(t[r[a]], ", ")),
                (o = null))
              : (n = "".concat(n).concat(t[r[a]], ", "))
        return n.slice(0, -2)
      }
      var ye = function (e) {
        var t = e.shouldShowControls,
          ...
          m = c[3],
          f = ve(u, d),
          b = ge(Object(a.useState)(f), 2),
          v = b[0],
          y = b[1],
          x = ge(Object(a.useState)(f), 2),
          E = x[0],
          C = x[1]
        Object(a.useEffect)(
          function () {
        ...
        var P = function () {
          o(h.a.setThumbnailSelectingPages(!0))
        }
        return s
          ? null
          : i.a.createElement(
              ...
              t
                ? i.a.createElement(
                    ...
                    m && i.a.createElement(fe, { parentElement: n }),
                    i.a.createElement(
                      "div",
                      ...
                      i.a.createElement("input", {
                        onBlur: function (e) {
                          ...
                          if (n.length || !t) {
                            o(h.a.setSelectedPageThumbnails(r))
                            var a = ve(u, d)
                            y(a), C(a)
                          } else y(E)
                          u.length > 0 &&
                          ...
                          ? i.a.createElement(w.a, {
                              ...
                              onClick: function () {
                                o(
                                  ...
                                  o(h.a.setThumbnailSelectingPages(!1))
                              },
      ...
      var we = ye,
        ...
        Pe = function (e, t) {
          ...
          return function (r) {
            return (
              r(h.a.openElement(E.a.LOADING_MODAL)),
              new Promise(function (o, a) {
                g.a
                  .mergeDocument(e, t)
                  .then(function (e) {
                    r(h.a.closeElement(E.a.LOADING_MODAL)),
                      g.a.setCurrentPage(t),
                      n && Object(Ee.a)(Ce.a.DOCUMENT_MERGED, e),
                      o(e)
                  })
                  .catch(function (e) {
                    a(e), r(h.a.closeElement(E.a.LOADING_MODAL))
                  })
              })
            )
          }
      ...
      var Ie = function (e) {
        var t = e.panelSelector,
          ...
          B = Se(Object(a.useState)(!1), 2),
          H = B[0],
          G = B[1],
          U = Se(Object(a.useState)(!0), 2),
          W = U[0],
          F = U[1],
          z = Se(Object(a.useState)(0), 2),
          q = z[0],
          Y = z[1],
          K = Se(Object(a.useState)(0), 2),
          $ = K[0],
          X = K[1],
          J = Se(Object(a.useState)(null), 2),
          Q = J[0],
          Z = J[1],
          ee = Se(Object(a.useState)(!1), 2),
          te = ee[0],
          ne = ee[1],
          re = Se(Object(a.useState)(1), 2),
          oe = re[0],
          ae = re[1],
          ie = Se(Object(a.useState)(!1), 2),
          le = ie[0],
          ce = ie[1],
          ue = Se(Object(a.useState)(150), 2),
          se = ue[0],
          de = ue[1],
          me = Se(Object(a.useState)(0), 2),
          pe = me[0],
          he = me[1],
          fe = Se(Object(a.useState)(0), 2),
          ge = fe[0],
          be = fe[1],
          ve = 2 === k ? S : f,
          ye = Object(l.d)(),
          Oe = {},
          Te = function (e) {
            var t = D.current && D.current[e] && D.current[e].element
            if (t) {
              var n = e + 1,
                r = g.a.getPageWidth(n),
                a = (function (e, t) {
                  var n, r, o
                  return (
                    e > t
                      ? ((o = e / se), (n = se), (r = Math.round(t / o)))
                      : ((o = t / se), (n = Math.round(e / o)), (r = se)),
                    { width: n, height: r }
                  )
                })(r, g.a.getPageHeight(n)),
                i = a.width,
                l = a.height,
                c =
              ...
              ;(c.className = "annotation-image"),
                (c.style.maxWidth = "".concat(se, "px")),
                (c.style.maxHeight = "".concat(se, "px"))
              ...
              d % 2 == 0
                ? ((c.width = i), (c.height = l), (s = c.width / r), (s /= m))
                : ((c.width = l), (c.height = i), (s = c.height / r), (s /= m)),
                t.appendChild(c),
                g.a.setAnnotationCanvasTransform(u, s, d)
              ...
              if (h)
                (p = Ae(
                  ...
                  Oe[n] || (Oe[n] = o()(g.a.drawAnnotations, 112)),
                  (0, Oe[n])(p)
            }
          }
        if (
            ...
            var e = function () {
              ...
              n = function () {
                ...
                (null === (e = g.a.getDocument()) || void 0 === e
                  ...
                  : G(!1),
                  (Oe = {}),
                  ye(h.a.setSelectedPageThumbnails([]))
              },
              r = function () {
                _.current && (g.a.setCurrentPage(_.current), (_.current = null))
              }
            return (
              g.a.addEventListener("beginRendering", e),
              g.a.addEventListener("finishedRendering", t),
              g.a.addEventListener("documentLoaded", n),
              g.a.addEventListener("pageComplete", r),
              g.a.getDocument() && n(),
              function () {
                g.a.removeEventListener("beginRendering", e),
                  ...
                  g.a.removeEventListener("pageComplete", r)
              }
            )
          }, []),
          Object(a.useEffect)(
              ...
              var e = function (e) {
                if (e) {
                  ...
                  e.removed &&
                    ...
                    ye(h.a.setSelectedPageThumbnails(t))
                }
              }
              return (
                g.a.addEventListener("pagesUpdated", e),
          ...
          Object(a.useEffect)(
            function () {
              ...
              null === (e = R.current) ||
                void 0 === e ||
                e.scrollToRow(Math.floor((b - 1) / oe))
              var t = function (e) {
                  var t = []
                  e.forEach(function (e) {
                    var n = e.PageNumber - 1
                    !e.Listable || t.indexOf(n) > -1 || (t.push(n), Te(n))
                  })
                },
                n = function (e) {
                  var t,
          ...
          Object(a.useEffect)(
            function () {
              ;(A || j) &&
                (ye(h.a.setSelectedPageThumbnails([])),
                ye(h.a.setThumbnailSelectingPages(!1)))
            },
            [A, j],
          ),
          s || H || (!r && !t))
        ...
        var je = function () {
          ...
          ke = function (e, t, n) {
            var r,
              o = new Date().getTime()
            return e < ve - 1 && e > 0 && o - pe >= n
              ? (null === (r = R.current) ||
                  void 0 === r ||
                  r.scrollToRow(Math.floor((e + t) / oe)),
                he(o),
                e + t)
              : e
          },
          ...
          Re = function (e, t) {
            ...
            var n,
              ...
              o = r
                ...
                : [t + 1]
            Object(Ee.a)(Ce.a.THUMBNAIL_DRAGGED),
              e.dataTransfer.setData("text", ""),
              o.length > 1 && e.dataTransfer.setDragImage(new Image(), 0, 0),
              y &&
                C &&
              ...
              r || ye(h.a.setSelectedPageThumbnails([t])),
          ...
          Me = function (e) {
            ...
            var t,
              ...
              r = te ? Q + 1 : Q + 2
            m.g || (t = e.dataTransfer.getData("dataTransferWebViewerFrame"))
            var o,
              a,
            ...
            if (y && i)
                ...
                ? ye(
                    ...
                    function (e) {
                      return new Promise(function (t, n) {
                        var r = window.parent.document.querySelector(
                          "#".concat(o),
                        )
                        r ||
                          (console.warn(
                          ...
                          n())
                        var i = r.contentWindow.extractedDataPromise
                        i ||
                          (console.warn(
                            "Could not retrieve data from other instance of WebViewer",
                          ),
                          n()),
                          e(h.a.openElement(E.a.LOADING_MODAL)),
                          i
                            .then(function (n) {
                              e(Pe(n, a, !1)).then(function (n) {
                                var o = n.filename,
                                  a = n.pages
                                Object(Ee.a)(Ce.a.DOCUMENT_MERGED, {
                                  filename: o,
                                  pages: r.contentWindow.pagesExtracted,
                                }),
                                  e(h.a.closeElement(E.a.LOADING_MODAL)),
                                  t({ filename: o, pages: a })
                              })
                            })
                            .catch(function (t) {
                              e(h.a.closeElement(E.a.LOADING_MODAL)), n(t)
                            })
                      })
                    }),
                  )
              ...
              ;(_.current =
                ...
                g.a.movePages(u, c)
              for (var s = [], d = 0; d < u.length; d++) s.push(_.current + d)
              Object(Ee.a)(Ce.a.THUMBNAIL_DROPPED, {
          ...
          De = function (e, t, n) {
            Be(e) ||
              He(e) ||
              ((D.current[e] = { element: t, loaded: !1 }),
          ...
          Be = function (e) {
            var t
            return null === (t = D.current[e]) || void 0 === t
              ? void 0
              : t.loaded
          },
          He = function (e) {
          ...
          Fe = function (e) {
            var n = e.index,
              r = e.key,
              o = e.style,
              a = d()({ columnsOfThumbnails: oe > 1, row: !0 }),
              l = !(A || j)
            return i.a.createElement(
              "div",
              {
              ...
              new Array(oe).fill().map(function (e, r) {
                var o = n * oe + r,
                  a = l && (y || x),
                  c = a && Q === o
                return o < ve
                        ...
                        "div",
                        {
                          ...
                          onContextMenu: function (e) {
                            return (
                              ...
                              v.includes(n) ||
                                ye(h.a.setSelectedPageThumbnails([n])),
                              void (
                                A ||
                                j ||
                                (ye(
                                  h.a.setPageManipulationOverlayAlternativePosition(
                                    {
                                      left: t.pageX,
                                      right: "auto",
                                      top: t.pageY,
          ...
          ze = function () {
            ae(Math.min(16, Math.max(1, Math.floor($ / se))))
          },
          Ve = P ? Number(se) + 50 : Number(se) + 80,
          qe = !(A || j),
          Ye = { height: "".concat(25, "px") }
        return i.a.createElement(
          i.a.Fragment,
          null,
          !T &&
            i.a.createElement(
              ...
              i.a.createElement(w.a, {
                ...
                hideTooltipShortcut: !0,
                onClick: function () {
                  se + Number("50") < 1001 && (de(se + Number("50")), ze())
                },
          ...
          i.a.createElement(
            u.a,
            {
              ...
              onResize: function (e) {
                ...
                Y(t.height),
                  X(t.width),
                  ae(Math.min(16, Math.max(1, Math.floor(t.width / se))))
              },
              key: se,
            },
            function (e) {
              ...
              return i.a.createElement(
                ...
                i.a.createElement(
                  ...
                  i.a.createElement(c.c, {
                    ...
                    width: $,
                    rowHeight: Ve,
                    rowCount: Math.ceil(ve / oe),
                    rowRenderer: Fe,
                    overscanRowCount: 3,
                    className: "thumbnailsList",
                    style: { outline: "none" },
                    scrollToIndex: Math.floor((b - 1) / oe),
                    role: "grid",
                    "aria-label": L("component.thumbnailsPanel"),
                  }),
                  le
                    ? i.a.createElement("div", {
                        className: "thumbnailAutoScrollArea",
                        onDragOver: Le,
                        style: Ae(Ae({}, Ye), {}, { bottom: "70px" }),
                      })
                    : "",
                ),
              )
          ...
          i.a.createElement(we, { shouldShowControls: qe, parentElement: t }),
        )
      }
      t.default = Ie
    },
