      ...
      var O = { date: "MM/DD/YYYY", time: "hh:mm A", timeFirst: !1 },
        ...
        j = function (t) {
          var e = t.state,
            ...
            S = l && l[0] ? l[0] : O,
            C = A(Object(n.useState)(_(S)), 2),
            M = C[0],
            T = C[1],
            j = A(Object(n.useState)(!0), 2),
            L = j[0],
            D = j[1],
            N = A(Object(n.useState)(!0), 2),
            I = N[0],
            P = N[1],
            R = A(Object(n.useState)(!0), 2),
            H = R[0],
            B = R[1],
            F = A(Object(n.useState)("Draft"), 2),
            z = F[0],
            U = F[1],
            G = A(Object(d.a)(), 1)[0],
            W = g(L, I, M),
            Y = A(Object(n.useState)(W), 2),
            V = Y[0],
            q = Y[1],
            X = Object(n.useRef)(),
            $ = Object(n.useRef)(),
          ...
          var Q = function (t) {
            ...
            xt = ht[0],
            bt = ht[1],
            wt = A(Object(n.useState)(null), 2),
            vt = wt[0],
            gt = wt[1],
            yt = function (t) {
              bt(t), (e = k(k({}, e), {}, { textColor: t })), K(z, V, e)
            },
            St = function (t) {
              st(t), (e = k(k({}, e), {}, { color: t })), K(z, V, e)
            },
            Ct = l || [O],
            kt = Array.from(
              new Set(
          ...
          return a.a.createElement(
            ...
            a.a.createElement(
              "div",
              { className: "canvas-container", ref: $ },
        ...
        return (
          ...
          (E.prototype = {
            ...
            delegateYield: function (t, e, o) {
              return (
                (this.delegate = { iterator: A(t), resultName: e, nextLoc: o }),
      ...
      var U = window.Core.Tools.RubberStampCreateTool.FILL_COLORS,
        G = function () {
          ...
          var E = function () {
            ...
            M = i()({ Modal: !0, CustomStampModal: !0, open: g, closed: !g }),
            O = (function () {
              var t = H(
                P().mark(function t() {
                  var o, n, a, i, c, s
