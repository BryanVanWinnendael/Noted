  ...
  [64],
  {
    ...
    1848: function (e, t, n) {
      ...
      var y = window.Core.Scale,
        M = { scale: w.a.array, onScaleChange: w.a.func, precision: w.a.number }
      function E(e) {
        var t = e.scale,
          n = e.onScaleChange,
          c = e.precision,
          ...
          s = x(Object(a.useState)(""), 2),
          d = s[0],
          m = s[1],
          f = x(Object(a.useState)(""), 2),
          h = f[0],
          w = f[1],
          v = x(Object(a.useState)(!1), 2),
          M = v[0],
          E = v[1],
          A = x(Object(a.useState)(""), 2),
          j = A[0],
          O = A[1],
          _ = x(Object(a.useState)(""), 2),
          k = _[0],
          C = _[1],
          D = x(Object(a.useState)(!1), 2),
          N = D[0],
          I = D[1],
        ...
        Object(a.useEffect)(
          function () {
            U.includes(t[0][1]) || G(U[0], !0)
          },
          [t[0][1]],
        ),
          Object(a.useEffect)(
            function () {
              U.includes(t[0][1]) && !H.includes(t[1][1]) && G(H[0], !1)
            },
            [t[0][1], t[1][1]],
          ),
          Object(a.useEffect)(
          ...
          Object(a.useEffect)(
            function () {
              if (F || B)
                !F && W(T.current.value, !0), !B && W(L.current.value, !1)
              else {
                var e = { value: t[0][0], unit: t[0][1] }
                W(T.current.value, !0, function (t) {
                  e = t.pageScale
                })
                var n = { value: t[1][0], unit: t[1][1] }
                W(L.current.value, !1, function (e) {
                  n = e.worldScale
                }),
      ...
      var T = window.Core.Scale,
        ...
        z = function (e) {
          var t,
            ...
            W = K[0],
            G = K[1],
            q = D(Object(a.useState)(u.r[u.a.DECIMAL][0]), 2),
            J = q[0],
            $ = q[1],
          ...
          Object(a.useEffect)(
            function () {
              u.r[be].includes(J) || $(u.r[be][0]), te(H[me][0])
            },
            [W],
          ),
            Object(a.useEffect)(
            ...
            Object(a.useEffect)(
              function () {
                M && U && !B && (Y(L), oe(u.l), G(!1), $(u.r[u.a.DECIMAL][0]))
              },
              [M, U],
            )
          var se = function () {
                    ...
                    o.a.createElement(
                      ...
                      o.a.createElement(
                        ...
                        o.a.createElement(
                          "p",
                          null,
                          x("option.measurementOption.scale"),
                        ),
                    ...
                    o.a.createElement(
                      ...
                      o.a.createElement(
                        ...
                        o.a.createElement(
                          ...
                          o.a.createElement(
                            ...
                            o.a.createElement(s.a, {
                              ...
                              checked: ue,
                              label: "".concat(
                                x("option.measurement.scaleModal.custom"),
                                ":",
                              ),
                              center: !0,
                            }),
                          ...
                          ue &&
                            o.a.createElement(
                              ...
                              x("option.measurement.scaleModal.calibrate"),
                            ),
                        ),
                        ue
                          ? o.a.createElement(A, {
                        ...
                        o.a.createElement(s.a, {
                          ...
                          checked: !ue,
                          label: "".concat(
                            x("option.measurement.scaleModal.preset"),
                            ":",
                          ),
                          center: !0,
                        }),
