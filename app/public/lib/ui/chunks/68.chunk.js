    ...
    1862: function (t, n, e) {
      ...
      function b() {
        ...
        var g = Object.getPrototypeOf,
          y = g && g(g(j([])))
        y && y !== n && e.call(y, i) && (m = y)
        var x = (f.prototype = u.prototype = Object.create(m))
        function w(t) {
                ...
                return new n(function (r, a) {
                  !(function o(r, i, a, c) {
                    ...
                    if ("throw" !== d.type) {
                      var l = d.arg,
                        s = l.value
                      return s && "object" == v(s) && e.call(s, "__await")
        ...
        return (
          (h.prototype = f),
          o(x, "constructor", { value: f, configurable: !0 }),
          o(f, "constructor", { value: h, configurable: !0 }),
          (h.displayName = d(f, c, "GeneratorFunction")),
          ...
          (t.mark = function (t) {
            return (
              Object.setPrototypeOf
                ...
                : ((t.__proto__ = f), d(t, c, "GeneratorFunction")),
        ...
        var t = r.a.createRef(),
          n = W(
            Object(i.e)(function (t) {
              return [
                f.a.getWarningTitle(t) || "",
                f.a.getWarningMessage(t),
                f.a.getWarningConfirmEvent(t),
                f.a.getWarningConfirmBtnText(t),
                f.a.getWarningSecondaryEvent(t),
                f.a.getWarningSecondaryBtnText(t),
                f.a.getWarningSecondaryBtnClass(t),
                f.a.getWarningCancelEvent(t),
                f.a.isElementDisabled(t, m.a.WARNING_MODAL),
                f.a.isElementOpen(t, m.a.WARNING_MODAL),
                f.a.getShowAskAgainCheckbox(t),
                f.a.getWarningTemplateStrings(t) || {},
                f.a.getWarningModalClass(t) || "",
                f.a.getWarningCloseEvent(t) || "",
              ]
            }, i.c),
            14,
          ),
          ...
          _ = n[12],
          T = n[13],
          C = W(Object(o.useState)(!1), 2),
          I = C[0],
          P = C[1],
          B = Object(i.d)(),
          D = Object(p.a)("Modal WarningModal ".concat(_), { isOpen: S }),
          G = a.a.t(w, O) || a.a.t("action.ok")
        Object(o.useEffect)(function () {
          return (
            c.a.addEventListener("documentUnloaded", H),
            function () {
              c.a.removeEventListener("documentUnloaded", H)
            }
          )
        }, []),
          Object(o.useEffect)(
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        ...
                        return (t.next = 5), T(I)
                      case 5:
                        B(h.a.closeElements(m.a.WARNING_MODAL))
                      case 6:
                      case "end":
                        return t.stop()
                    }
              ...
              r.a.createElement(
                ...
                r.a.createElement(
                  "div",
                  {
                    ...
                    role: "alertdialog",
                    "aria-modal": "true",
                    "aria-label": a.a.t(e, O),
                    "aria-describedby": a.a.t(e, O),
                  },
                  r.a.createElement(
                    "div",
                    {
                    ...
                    r.a.createElement(
                      ...
                      E &&
                        r.a.createElement(d.a, {
                          className: u()(x({ "modal-button": !0 }, A, A)),
