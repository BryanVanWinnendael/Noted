  ...
  [65],
  {
      ...
      var l = {
        insert: function (e) {
          ...
          ;(t = document.getElementsByTagName("apryse-webviewer")),
            t.length ||
              (t = (function e(t, a = document) {
                const n = []
                return (
                  a.querySelectorAll(t).forEach((e) => n.push(e)),
                  a.querySelectorAll("*").forEach((a) => {
                    a.shadowRoot && n.push(...e(t, a.shadowRoot))
                  }),
                  n
                )
              })("apryse-webviewer"))
    ...
    1826: function (e, t, a) {
      ...
      a(23),
        ...
        a(18)
      var n = a(2),
        r = (a(34), a(179), a(24), a(46), a(0)),
        l = a.n(r),
        o = a(39),
        i = (a(97), a(111), a(91), a(17)),
        c = a.n(i),
        s = a(71),
        u = a(4),
        d = a.n(u),
      ...
      var O = {
        ...
        E = function (e) {
          ...
          var N = g(Object(r.useState)(!1), 2),
            T = N[0],
            _ = N[1],
            k = Object(r.useRef)(null)
          return (
            Object(y.a)(k, function () {
              _(!1)
            }),
            l.a.createElement(
              s.a,
                ...
                l.a.createElement(
                  ...
                  E &&
                    l.a.createElement(
                      ...
                      l.a.createElement(
                        "button",
                        { onMouseDown: b, className: "add-new-scale" },
      ...
      function F(e) {
        var t,
          ...
          u = null == n ? void 0 : n.Measure.axis[0].factor,
          d =
            (null == n ? void 0 : n.DisplayUnits[0]) ||
            (null == i || null === (t = i.Measure) || void 0 === t
              ? void 0
              : t.unit),
          y = L(
            Object(r.useState)(
              ((null == n ? void 0 : n.getLineLength()) * u || 0).toFixed(2),
            ),
            2,
          ),
          h = y[0],
          g = y[1],
          b = L(Object(r.useState)(!1), 2),
          S = b[0],
          O = b[1],
          w = L(Object(r.useState)(!1), 2),
          E = w[0],
          M = w[1]
        Object(r.useEffect)(
          function () {
            if (n) {
              var e = function () {
                g((n.getLineLength() * u).toFixed(2)), H(F())
              }
              return (
                v.a.addEventListener("mouseMove", e),
                function () {
                  v.a.removeEventListener("mouseMove", e)
                }
              )
            }
            H(F())
        ...
        var A = function (e) {
            g(e.target.value), N(e), x()
          },
          x = function () {
            v.a.getTool("AnnotationCreateDistanceMeasurement").finish()
          },
          j = function () {
            v.a.getAnnotationManager().selectAnnotation(n)
          },
          C = function () {
            v.a.getAnnotationManager().deselectAnnotation(n)
          },
          N = function (e) {
            if (n) {
              var t = Math.abs(e.target.value)
              t < n.Precision && ((t = n.Precision), g(t))
              var a = n.Measure.axis[0].factor
              T(t / a)
            }
          },
          T = Object(r.useCallback)(
            function (e) {
              if (
                ((a = n.getLineLength()), (r = e), !(Math.abs(a - r) < 0.1))
              ) {
                var t = I()
                n.setLineLength(Math.min(t, e)), k()
              }
              var a, r
            },
            [n, k, I],
          ...
          k = Object(r.useCallback)(
            function () {
              var e = v.a.getAnnotationManager()
              e.drawAnnotations(n.PageNumber),
                e.trigger("annotationChanged", [[n], "modify", {}])
            },
            [n],
          ),
          I = Object(r.useCallback)(
            function () {
              var e,
                t,
                a = v.a.getCurrentPage(),
                r = v.a.getPageWidth(a),
                l = v.a.getPageHeight(a),
                o = n.getAngle() * (180 / Math.PI).toFixed(2),
                i = n.getStartPoint(),
                c = i.x,
                s = i.y
              ;(e = Math.abs(o) < 90 ? r : 0), (t = o > 0 ? l : 0)
              var u = Math.abs((e - c) / Math.cos(n.getAngle())),
                d = Math.abs((t - s) / Math.sin(n.getAngle()))
              return Math.min(u, d)
            },
            [n],
          ),
            ...
            H(e.target.value),
              (function (e) {
                var t = e.target.value * (Math.PI / 180) * -1,
                  ...
                  l = Math.cos(t) * a + r.x,
                  o = Math.sin(t) * a + r.y
                n.setEndPoint(l, o), n.adjustRect(), k()
              })(e),
              x()
          },
        ...
        return (
          ...
          l.a.createElement(
            ...
            l.a.createElement(
              ...
              n && S
                ...
                : l.a.createElement(
                    ...
                    (null == n ||
                    null === (a = n.getMeasurementTextWithScaleAndUnits) ||
                    void 0 === a
                      ? void 0
                      : a.call(n)) || 0,
                  ),
            ...
            (function () {
              var e = (n && R(n.Start, n.End)) || 0,
                t = _(n),
                a = U.getFormattedValue(
                  n && Math.abs(h * Math.cos(e)),
                  t,
                  null == n ? void 0 : n.Precision,
                ),
                r = U.getFormattedValue(
                  n && Math.abs(h * Math.sin(e)),
                  t,
                  null == n ? void 0 : n.Precision,
                )
              return l.a.createElement(
      ...
      function G(e) {
        var t,
          ...
          d =
            (null == o ||
            null === (t = o.getMeasurementTextWithScaleAndUnits) ||
            void 0 === t
              ? void 0
              : t.call(o)) || 0,
          y = {
            precision: o
              ? o.Precision
              : null == c || null === (a = c.defaults) || void 0 === a
                ? void 0
                : a.Precision,
            unit: B(
              ((null == o ? void 0 : o.Scale) ||
                (null == c || null === (n = c.defaults) || void 0 === n
                  ? void 0
                  : n.Scale))[1][1],
            ),
            area: d,
        ...
        Object(r.useEffect)(
          function () {
            return (
              h(),
              v.a.addEventListener("mouseMove", h),
              function () {
                v.a.removeEventListener("mouseMove", h)
              }
            )
          },
          [o],
          ...
          Object(r.useEffect)(function () {
            ...
            return (
              v.a.addEventListener("annotationSelected", e),
              function () {
                v.a.removeEventListener("annotationSelected", e)
              }
            )
          }, [])
        var g = function () {
            if (!o) return 0
            var e = (o && I(o.Precision)) || 0,
              t = o.Measure.axis[0].factor
            return ((o.Width / 2).toFixed(e) * t).toFixed(e)
          },
          b = function (e) {
            var t = e.target.value || 0,
              a = t > 0 ? t : 1e-4,
              n = 2 * (a / o.Measure.axis[0].factor),
              r = o.getRect(),
              l = { x1: r.x1, y1: r.y1, x2: r.x1 + n, y2: r.y1 + n }
            o.setHeight(n),
              o.setWidth(n),
              o.resize(l),
              A(a),
              S(o),
              v.a.getTool("AnnotationCreateEllipseMeasurement").finish()
          },
          S = function (e) {
            var t = v.a.getAnnotationManager()
            t.redrawAnnotation(e),
              t.trigger("annotationChanged", [[e], "modify", []])
          },
          O = Object(r.useCallback)(function (e) {
            var t = v.a.getCurrentPage(),
              a = v.a.getPageWidth(t),
              n = v.a.getPageHeight(t),
              r = a - e.X,
              l = n - e.Y
            return Math.min(r, l)
          }),
            ...
            function (e, t) {
              if (e > O(t)) {
                var a = t.getRect(),
                  ...
                  i = t.Width,
                  c = t.Height,
                  s = v.a.getCurrentPage(),
                  u = v.a.getPageWidth(s),
                  d = v.a.getPageHeight(s)
                r > u && ((a.x2 = u), (i = u - n)),
                  o > d && ((a.y2 = d), (c = d - l)),
        ...
        return l.a.createElement(
          ...
          l.a.createElement(
            ...
            l.a.createElement(
              "div",
              { className: "measurement_list" },
              s("option.measurementOverlay.area"),
              ":",
            ),
            l.a.createElement("div", { className: "distance-show" }, y.area),
          ),
          l.a.createElement(
            "div",
            { className: "measurement__detail-item" },
            l.a.createElement(
              "div",
              { className: "measurement_list" },
              s("option.measurementOverlay.radius"),
              ":",
            ),
            o
              ? l.a.createElement(
                  ...
                  l.a.createElement("input", {
                    ...
                    value: M,
                    onChange: function (e) {
                      b(e), v.a.getAnnotationManager().selectAnnotation(o)
                    },
                    onBlur: function (e) {
                      return (function (e) {
                        var t = Math.abs(e.target.value),
                          a = o.Measure.axis[0].factor
                        w(2 * (t / a), o), h()
                      })(e)
                    },
                    onKeyDown: function (e) {
                      "Enter" === e.key &&
                        (b(e), v.a.getAnnotationManager().deselectAnnotation(o))
                    },
                  }),
                  y.unit,
                )
          ...
          var t,
            ...
            p = Object(r.useMemo)(function () {
              var e,
                ...
                a,
                n,
                r = c ? Object(T.g)(c) : Object(T.j)(u.name)
              return {
                key: r,
                icon: Object(T.e)(r).icon,
                color: c
                  ? c.Color.toHexString()
                  : null == u ||
                      null === (e = u.defaults) ||
                    ...
                    : t.toHexString(),
                contents: c
                  ? null === (a = c.getMeasurementTextWithScaleAndUnits) ||
                    void 0 === a
                    ? void 0
                    : a.call(c)
                  : 0,
                precision: c
                  ? c.Precision
                  : null == u || null === (n = u.defaults) || void 0 === n
                    ? void 0
                    : n.Precision,
              }
            })
      ...
      var se = window.Core.Scale,
        ...
        de = function (e) {
          var t = e.annotations,
            ...
            h = y.isCalibration,
            g = y.tempScale,
            b = y.previousToolName,
            S = void 0 === b ? "AnnotationCreateDistanceMeasurement" : b,
            O = y.isFractionalUnit,
            w = m[1],
            E = oe(Object(r.useState)(v.a.getScales()), 2),
            M = E[0],
            A = E[1],
            x = !(!Object.keys(M).length || (!a && (!t.length || t.length > 1)))
          Object(r.useEffect)(
            function () {
              d()
            },
            ...
            Object(r.useEffect)(function () {
              ...
              return (
                v.a.addEventListener("scaleUpdated", e),
                v.a.addEventListener("createAnnotationWithNoScale", a),
                v.a.addEventListener("annotationsLoaded", t),
                v.a.addEventListener("annotationChanged", t),
                function () {
                  v.a.removeEventListener("scaleUpdated", e),
                    v.a.removeEventListener("createAnnotationWithNoScale", a),
                    v.a.removeEventListener("annotationsLoaded", t),
                    v.a.removeEventListener("annotationChanged", t)
                }
              )
            }, []),
            Object(r.useEffect)(
              function () {
                "AnnotationCreateCalibrationMeasurement" === w
                  ? (!h && n(!0), o(!0))
                  : (n(!1), o(!1))
              },
              [w, n, o],
          ...
          var j = Object(r.useMemo)(
            ...
            C = Object.keys(M).map(function (e) {
              return new se(e)
            })
          return h
      ...
      t.default = function (e) {
        var t = e.annotations,
          ...
          s = he(
            Object(p.e)(function (e) {
              return [
                f.a.isElementDisabled(e, ve.a.SCALE_OVERLAY_CONTAINER),
                f.a.isElementOpen(e, ve.a.SCALE_OVERLAY_CONTAINER),
                f.a.getScaleOverlayPosition(e),
              ]
            }),
            3,
          ),
          ...
          d = s[1],
          y = s[2],
          h = he(Object(r.useState)({ x: 0, y: 0 }), 2),
          g = h[0],
          b = h[1],
          S = he(
            Object(r.useReducer)(
          ...
          A = v.a.getViewerElement(),
          x = v.a.getScrollViewElement(),
          j = (function () {
            var e = y.split("-"),
              t = { left: 0, top: 0 }
            if ("top" === e[0])
              t.top = (null == A ? void 0 : A.offsetTop) + 10 || 85
            else {
              var a = 400
              null != M &&
                M.current &&
                (a = M.current.getBoundingClientRect().height),
                (t.top = E + (null == x ? void 0 : x.offsetTop) - 10 - a || 85)
            }
            if ("right" === e[1])
              (t.left = 0.666 * w),
                A &&
                  ...
                  (t.left = Math.min(
                    (null == A ? void 0 : A.offsetLeft) +
                      ...
                      10 || t.left,
                    w - M.current.getBoundingClientRect().width - 10,
                  ))
            else {
              if (A && null != M && M.current) {
                var n = M.current.getBoundingClientRect().width
                ;(t.left = (null == A ? void 0 : A.offsetLeft) - 10 - n || 10),
                  x && t.left < x.offsetLeft && (t.left = x.offsetLeft + 10)
              }
              ;(!t.left || isNaN(t.left) || t.left < 0) && (t.left = 10)
            }
            return t
          })()
        Object(r.useEffect)(
        ...
        var C,
          ...
          _ = Object(r.useCallback)(function (e) {
            o(n.a.updateCalibrationInfo({ isCalibration: e }))
          }, []),
          k = Object(r.useCallback)(function (e) {
            Oe.forEach(function (t) {
              o(n.a.setCustomElementOverrides(t, { disabled: e }))
            })
          }, []),
          I = Object(r.useCallback)(function (e) {
            e &&
              (function (e) {
                o(n.a.setSelectedScale(e))
              })(new Se(e)),
              o(n.a.openElements([ve.a.SCALE_MODAL])),
              o(n.a.setIsAddingNewScale())
          }, []),
          D = Object(r.useCallback)(
            function (e, n) {
              var r = new Se(n)
              if (1 === e.length && e.includes(n)) I(n)
              else {
                var l = [].concat(ye(t), [a]),
                  o = v.a
                    .getDocumentViewer()
                  ...
                  i = function () {
                    v.a.createAndApplyScale(r, [].concat(ye(t), [a]))
                  }
                o ? R(o, i) : i()
              }
            },
          ...
          R = function (e, t) {
            ...
            o(n.a.showWarningMessage(a))
          },
          L = Object(r.useCallback)(function (e) {
            v.a.setToolMode(e),
              _(!1),
              o(n.a.setIsElementHidden(ve.a.SCALE_MODAL, !1))
          }, []),
          P = Object(r.useCallback)(
            function (e, a, r) {
              o(
                ...
                o(n.a.setIsElementHidden(ve.a.SCALE_MODAL, !1)),
                v.a.setToolMode(e),
                v.a.deleteAnnotations([t[0]])
            },
            [t],
          ),
          q = Object(r.useCallback)(function () {
            I(), o(n.a.setIsAddingNewScale(!0))
          }, [])
        return (
          !u &&
          l.a.createElement(
            fe.a,
            {
              ...
              bounds:
                ((C = y.split("-")),
                (N = { top: 0, bottom: 0, left: 0, right: 0 }),
                "top" === C[0]
                  ? ((N.top = 0),
                    (N.bottom = E - 20),
                    M.current
                      ? (N.bottom -= M.current.getBoundingClientRect().height)
                      : (N.bottom -= 85))
                  : ((N.top = 20 - E),
                    M.current
                      ? (N.top += M.current.getBoundingClientRect().height)
                      : (N.top += 85),
                    (N.bottom = 0)),
                "right" === C[1]
                  ? ((N.left = -w),
                    (N.right = w / 3),
                    j && (N.right = w - j.left))
                  : ((N.left = null == x ? void 0 : x.offsetLeft),
                    j &&
                      (N.left =
                        (null == x ? void 0 : x.offsetLeft) - j.left + 10),
                    (N.right = w - 10 - 35),
                    j && (N.right -= j.left)),
                N),
              onDrag: T,
            ...
            l.a.createElement(
              "div",
              {
                ...
                "data-element": ve.a.SCALE_OVERLAY_CONTAINER,
                style: j,
                ref: M,
              },
              l.a.createElement(me, {
                annotations: t,
                selectedTool: a,
                updateIsCalibration: _,
                enableOrDisableToolElements: k,
                onScaleSelected: D,
                onCancelCalibrationMode: L,
                onApplyCalibration: P,
                onAddingNewScale: q,
                forceUpdate: S,
              }),
            ),
