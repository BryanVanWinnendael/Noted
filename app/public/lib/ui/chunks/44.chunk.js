  ...
  [44],
  {
          ...
          ;(e = document.getElementsByTagName("apryse-webviewer")),
            e.length ||
              (e = (function t(e, o = document) {
                const r = []
                return (
                  o.querySelectorAll(e).forEach((t) => r.push(t)),
                  o.querySelectorAll("*").forEach((o) => {
                    o.shadowRoot && r.push(...t(e, o.shadowRoot))
                  }),
                  r
                )
              })("apryse-webviewer"))
    ...
    1842: function (t, e, o) {
      ...
      function b() {
        ...
        function d(t, e, o, n) {
          var i = e && e.prototype instanceof s ? e : s,
            ...
            l = new O(n || [])
          return r(a, "_invoke", { value: P(t, o, l) }), a
        }
        function p(t, e, o) {
          try {
        ...
        var x = (h.prototype = s.prototype = Object.create(m))
        function w(t) {
                ...
                return new e(function (n, a) {
                  !(function r(n, i, a, l) {
                    ...
                    if ("throw" !== c.type) {
                      var d = c.arg,
                        u = d.value
                      return u && "object" == y(u) && o.call(u, "__await")
        ...
        function P(t, e, o) {
          ...
          return function (n, i) {
            ...
            for (o.method = n, o.arg = i; ; ) {
              ...
              if ("normal" === c.type) {
                if (
                  ((r = o.done ? "completed" : "suspendedYield"), c.arg === u)
                )
                  continue
      ...
      function j() {
        ...
        var b = (h.prototype = s.prototype = Object.create(m))
        function g(t) {
          ;["next", "throw", "return"].forEach(function (e) {
            c(t, e, function (t) {
              return this._invoke(e, t)
                ...
                return new e(function (n, a) {
                  !(function r(n, i, a, l) {
                    ...
                    if ("throw" !== c.type) {
                      var d = c.arg,
                        u = d.value
                      return u && "object" == L(u) && o.call(u, "__await")
                        ? e.resolve(u.__await).then(
                            function (t) {
                              r("next", t, a, l)
                            },
          ...
          (M.prototype = {
            ...
            finish: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                var o = this.tryEntries[e]
                if (o.finallyLoc === t)
                  return this.complete(o.completion, o.afterLoc), C(o), u
              }
            },
            catch: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
        ...
        var t = S(Object(a.a)(), 1)[0],
          ...
          o = S(
            Object(i.e)(function (t) {
              return [
                l.a.isElementDisabled(t, u.a.CREATE_PORTFOLIO_MODAL),
                l.a.isElementOpen(t, u.a.CREATE_PORTFOLIO_MODAL),
                l.a.getIsMultiTab(t),
                l.a.getTabManager(t),
              ]
            }, i.c),
          ...
          y = o[2],
          b = o[3],
          g = S(Object(r.useState)([]), 2),
          x = g[0],
          w = g[1],
          E = Object(r.useRef)(null),
          P = function () {
            e(c.a.closeElement(u.a.CREATE_PORTFOLIO_MODAL))
          },
          C = function (t) {
            w(t)
          },
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      ...
                      case 2:
                        ...
                        return (
                          (t.t0 = Blob), (t.next = 7), o.saveMemoryBuffer(0)
                        )
                      case 7:
                        return (
                          (t.t1 = t.sent),
                          (t.t2 = [t.t1]),
                          (t.t3 = { type: "application/pdf" }),
                          (r = new t.t0(t.t2, t.t3)),
                          (t.next = 13),
                          b.addTab(r, { setActive: !0, extension: "pdf" })
                        )
                      case 13:
                        t.next = 16
                        break
          ...
          _ = function (o) {
            if (o.length > 0) {
              ...
              if (r) {
                ...
                e(c.a.showWarningMessage(n))
              } else w(x.concat(o))
            }
          },
          N = function () {
            var t
            null == E || null === (t = E.current) || void 0 === t || t.click()
          },
          I = p()({ CreatePortfolioModal: !0, "is-editing": x.length > 0 }),
          D = p()({ "add-item-option": !0 })
        return d || !v
          ? null
          : n.a.createElement(
              "div",
              {
                className: I,
                "data-element": u.a.CREATE_PORTFOLIO_MODAL,
                onClick: P,
              },
              n.a.createElement(
                "div",
                ...
                0 === x.length &&
                  n.a.createElement(
                    f.d,
                    { id: u.a.CREATE_PORTFOLIO_MODAL },
                    n.a.createElement(
                      "div",
                      { className: "tab-list" },
                      n.a.createElement(
                        f.a,
                        { dataElement: u.a.PORTFOLIO_UPLOAD_FILES_TAB },
                        n.a.createElement(
                          "button",
                  ...
                  n.a.createElement(
                    ...
                    n.a.createElement(M, {
                      ...
                      onDropItems: function (t) {
                        t.preventDefault(), _(t.dataTransfer.files)
                      },
                    }),
                  ),
                n.a.createElement("div", { className: "divider" }),
                n.a.createElement(
                  ...
                  n.a.createElement(
                    ...
                    n.a.createElement("div", {
                      ...
                      "data-element": u.a.PORTFOLIO_MODAL_ADD_ITEM_TRIGGER,
                    }),
                  ),
                  n.a.createElement(
                    "button",
                ...
                n.a.createElement("input", {
                  ...
                  type: "file",
                  onChange: function (t) {
                    _(t.target.files), (t.target.value = null)
                  },
                }),
              ),
            )
