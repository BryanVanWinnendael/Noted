;(window.webpackJsonp = window.webpackJsonp || []).push([
  [29],
  {
    ...
    1366: function (e, t, n) {
      ...
      var r = { OUTLINE: "outline", PORTFOLIO: "portfolio" },
        o = {
    ...
    1379: function (e, t, n) {
      ...
      var y = {
          ...
          outlinePath: c.a.string,
          isAdding: c.a.bool,
          isOutlineRenaming: c.a.bool,
          setOutlineRenaming: c.a.func,
          isOutlineChangingDest: c.a.bool,
          setOutlineChangingDest: c.a.func,
          setIsHovered: c.a.func,
          onCancel: c.a.func,
        ...
        b = function (e) {
          var t = e.text,
            n = e.outlinePath,
            a = e.isAdding,
            c = e.isOutlineRenaming,
            f = e.setOutlineRenaming,
            p = e.isOutlineChangingDest,
            h = e.setOutlineChangingDest,
            v = e.setIsHovered,
            y = e.onCancel,
            b = e.textColor,
            w = Object(r.useContext)(d.a),
            O = w.currentDestPage,
            E = w.currentDestText,
            x = w.editingOutlines,
            k = w.setEditingOutlines,
            T = w.isMultiSelectMode,
            L = w.isOutlineEditable,
            N = w.addNewOutline,
            j = w.renameOutline,
            A = w.updateOutlineDest,
            S = w.updateOutlines,
            I = w.removeOutlines,
            _ = g(Object(i.a)(), 1)[0],
            C = g(Object(r.useState)(!1), 2),
            D = C[0],
            P = C[1],
            R = g(Object(r.useState)(t), 2),
            M = R[0],
            G = R[1],
            B = g(Object(r.useState)(!1), 2),
            U = B[0],
            H = B[1],
            W = Object(r.useRef)(),
            F = function () {
          ...
          Object(r.useEffect)(
            ...
            Object(r.useEffect)(
              function () {
                ;(a || c) && (W.current.focus(), W.current.select()),
                  P(!a && !c && !p)
              },
              [c, p],
            ),
          ...
          return o.a.createElement(
                ...
                U &&
                  o.a.createElement(s.a, {
                    ...
                    onSetDestinationClick: function () {
                      H(!1),
                        h(!0),
                        l.a.setToolMode("OutlineDestinationCreateTool")
                    },
            ...
            p &&
              o.a.createElement(
                "div",
                { className: "bookmark-outline-text outline-text", style: Y },
                t,
              ),
            (a || c) &&
              o.a.createElement("input", {
                ...
                placeholder: _("component.outlineTitle"),
                "aria-label": _("action.name"),
                value: M,
                onKeyDown: function (e) {
                  "Enter" === e.key &&
                    (e.stopPropagation(), a && F(), c && !z() && V()),
                    "Escape" === e.key && q()
                },
                onChange: function (e) {
            ...
            (a || p) &&
              o.a.createElement(
                ...
                _("component.destination"),
                ": ",
                _("component.bookmarkPage"),
                " ",
                O,
                ",",
                o.a.createElement(
    ...
    1447: function (e, t, n) {
      ...
      function h() {
        ...
        function u(e, t, n, o) {
          var i = t && t.prototype instanceof f ? t : f,
            ...
            c = new N(o || [])
          return r(a, "_invoke", { value: x(e, n, c) }), a
        }
        function s(e, t, n) {
          try {
        ...
        return (
          ...
          (p.displayName = l(g, c, "GeneratorFunction")),
      ...
      var w = function () {
        var e = Object(i.e)(function (e) {
          ...
          t = Object(r.useContext)(u.a),
          n = t.activeOutlinePath,
          m = t.setActiveOutlinePath,
          g = t.updateOutlines,
          b = y(
            Object(r.useState)({ up: !1, down: !1, outward: !1, inward: !1 }),
            2,
          ),
          w = b[0],
          O = b[1],
        ...
        Object(r.useEffect)(
                    ...
                    return h().wrap(function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.t0 = O), (e.next = 3), d.a.getCanMoveState(n)
                            )
                          case 3:
          ...
          Object(r.useEffect)(
            function () {
              null !== E.current && (m(E.current), (E.current = null))
            },
            [e, m],
          )
        var k = (function () {
        ...
        return o.a.createElement(
          l.a,
          { className: "OutlineControls", dataElement: p.a.OUTLINE_CONTROLS },
          o.a.createElement(
            "span",
            { className: "reorderText" },
            x("option.bookmarkOutlineControls.reorder"),
          ),
          o.a.createElement(c.a, {
            img: "icon-arrow-up",
            disabled: !w.up,
            onClick: k,
            dataElement: p.a.OUTLINE_MOVE_UP_BUTTON,
          }),
          o.a.createElement(c.a, {
            img: "icon-arrow-down",
            disabled: !w.down,
            onClick: T,
            dataElement: p.a.OUTLINE_MOVE_DOWN_BUTTON,
          }),
          o.a.createElement(c.a, {
            img: "icon-arrow-left",
            disabled: !w.outward,
            onClick: L,
            dataElement: p.a.OUTLINE_MOVE_OUTWARD_BUTTON,
          }),
          o.a.createElement(c.a, {
            img: "icon-arrow-right",
            disabled: !w.inward,
            onClick: N,
            dataElement: p.a.OUTLINE_MOVE_INWARD_BUTTON,
          }),
        )
      }
      t.a = w
    ...
    1448: function (e, t, n) {
      ...
      var j = {
          outline: l.a.object.isRequired,
          setMultiSelected: l.a.func,
          moveOutlineInward: l.a.func.isRequired,
          moveOutlineBeforeTarget: l.a.func.isRequired,
          moveOutlineAfterTarget: l.a.func.isRequired,
          connectDragSource: l.a.func,
          connectDragPreview: l.a.func,
          connectDropTarget: l.a.func,
          isDragging: l.a.bool,
          isDraggedUpwards: l.a.bool,
          isDraggedDownwards: l.a.bool,
        },
        A = Object(r.forwardRef)(function (e, t) {
          var n = e.outline,
            i = e.setMultiSelected,
            c = e.isDragging,
            l = e.isDraggedUpwards,
            s = e.isDraggedDownwards,
            d = e.connectDragSource,
            p = e.connectDragPreview,
            v = e.connectDropTarget,
            y = e.moveOutlineInward,
            N = e.moveOutlineBeforeTarget,
            j = e.moveOutlineAfterTarget,
            A = Object(u.e)(function (e) {
              return g.a.getOutlines(e)
            }),
            I = Object(r.useContext)(O.a),
            _ = I.setActiveOutlinePath,
            C = I.activeOutlinePath,
            D = I.isOutlineActive,
            P = I.setAddingNewOutline,
            R = I.isAddingNewOutline,
            M = I.isAnyOutlineRenaming,
            G = I.isMultiSelectMode,
            B = I.shouldAutoExpandOutlines,
            U = I.isOutlineEditable,
            H = I.selectedOutlines,
            W = I.updateOutlines,
            F = b.a.getPath(n),
            V = L(Object(r.useState)(B), 2),
            q = V[0],
            z = V[1],
            Y = L(Object(r.useState)(H.includes(F)), 2),
            $ = Y[0],
            Z = Y[1],
            J = L(Object(r.useState)(!1), 2),
            K = J[0],
            X = J[1],
            Q = L(Object(r.useState)(!1), 2),
            ee = Q[0],
            te = Q[1],
            ne = L(Object(r.useState)(!1), 2),
            re = ne[0],
            oe = ne[1],
            ie = L(Object(r.useState)(void 0), 2),
            ae = ie[0],
            ce = ie[1],
            le = Object(u.d)(),
            ue = Object(r.useRef)(null)
          d(ue), p(Object(f.a)(), { captureDraggingState: !0 }), v(ue)
          var se = c ? 0.5 : 1
            ...
            ge = Object(r.useCallback)(
              function () {
                m.a.goToOutline(n),
                  _(F === C ? null : F),
                  R && (P(!1), W()),
                  Object(w.l)() && le(h.a.closeElement("leftPanel"))
              },
              [le, _, C, R, n],
            ),
            ve = D(n)
          return o.a.createElement(
            ...
            o.a.createElement(
              x.a,
              {
                ...
                onClick: function (e) {
                  K || ee || 1 !== e.detail || ce(setTimeout(ge, 300))
                },
                onDoubleClick: function () {
                  K || ee || clearTimeout(ae)
                },
              },
              G &&
                o.a.createElement(k.a, {
                  ...
                  id: "outline-checkbox-".concat(F),
                  checked: $,
                  onClick: function (e) {
                    return e.stopPropagation()
                  },
                  onChange: function (e) {
                    Z(e.target.checked), i(F, e.target.checked)
                  },
                }),
              o.a.createElement(
                "div",
              ...
              o.a.createElement(E.a, {
                ...
                textColor: n.color
                  ? ((de = n.color),
                    ...
                    (pe = 255 * de.g),
                    (me = 255 * de.b),
                    "rgb(".concat(fe, ", ").concat(pe, ", ").concat(me, ")"))
                  : null,
              }),
            ),
            o.a.createElement("div", {
            ...
            q &&
              n.getChildren().map(function (e) {
                return o.a.createElement(S, {
                  ...
                  setMultiSelected: i,
                  moveOutlineInward: y,
                  moveOutlineBeforeTarget: N,
                  moveOutlineAfterTarget: j,
                })
              }),
            R &&
              ve &&
            ...
            if (n) {
              ...
              if (r) {
                ...
                if (i && c) {
                  if (i.contains(c))
                    return (
                      (r.dropTargetNode = void 0),
                      void (r.dropLocation = p.b.INITIAL)
                    )
                  r.dropTargetNode = c
                  var l = o.index,
                    u = a.index
                  if (o.parent !== a.parent || l !== u) {
                    var s = c.getBoundingClientRect(),
                      d = (s.bottom - s.top) / 2,
                      f = t.getClientOffset().y - s.top
                    switch (!0) {
                      case f <= d + p.a && f >= d - p.a:
                        ;(r.dropLocation = p.b.ON_TARGET_HORIZONTAL_MIDPOINT),
                          t.isOver({ shallow: !0 }) &&
                            c.classList.add("isNesting"),
                          setTimeout(function () {
                            ;(null == r ? void 0 : r.dropTargetNode) !== c &&
                              c.classList.remove("isNesting")
                          }, 100)
                        break
                      case f > d + p.a:
                        ;(r.dropLocation = p.b.BELOW_TARGET),
                          c.classList.remove("isNesting")
                        break
                      case f < d - p.a:
                        ;(r.dropLocation = p.b.ABOVE_TARGET),
                          c.classList.remove("isNesting")
                        break
                      default:
                        ;(r.dropLocation = p.b.INITIAL),
                          c.classList.remove("isNesting")
                    }
                    Object(y.a)(v.a.DRAG_OUTLINE, {
                      targetOutline: a,
                      draggedOutline: r.dragOutline,
          ...
          drop: function (e, t, n) {
            if (n) {
              var r = t.getItem(),
                ...
                i = r.dropTargetNode,
                a = e.outline,
                c = e.moveOutlineInward,
                l = e.moveOutlineBeforeTarget,
                u = e.moveOutlineAfterTarget
              if (i) {
                switch (r.dropLocation) {
                  case p.b.ON_TARGET_HORIZONTAL_MIDPOINT:
                    c(o, a)
                    break
                  case p.b.ABOVE_TARGET:
                    l(o, a)
                    break
                  case p.b.BELOW_TARGET:
                    u(o, a)
                }
          ...
          return {
            ...
            isDraggedUpwards:
              ...
              (null === (n = t.getItem()) || void 0 === n
                ? void 0
                : n.dropLocation) === p.b.ABOVE_TARGET,
            isDraggedDownwards:
              t.isOver({ shallow: !0 }) &&
              (null === (r = t.getItem()) || void 0 === r
                ? void 0
                : r.dropLocation) === p.b.BELOW_TARGET,
          }
        },
        ...
        L = function (e, t) {
          ...
          var n = t.x,
            ...
            o = "translate(calc("
              .concat(n, "px - 50%), calc(")
              .concat(r, "px - 100%))")
          return { transform: o, WebkitTransform: o }
        },
        N = function () {
          var e = Object(x.a)(function (e) {
              return {
      ...
      var R = function () {
          var e = C(
              Object(i.e)(function (e) {
                return [
                  E.a.isElementDisabled(e, "outlines-panel"),
                  E.a.getOutlines(e),
                  E.a.isOutlineControlVisible(e),
                  E.a.getOutlineEditingEnabled(e),
                  E.a.shouldAutoExpandOutlines(e),
                  E.a.getCurrentPage(e),
                  E.a.getPageLabels(e),
                ]
              }, i.c),
              7,
            ...
            D = "Area Selection",
            P = { x: 0, y: 0 },
            R = C(Object(r.useState)(I), 2),
            M = R[0],
            G = R[1],
            B = C(Object(r.useState)(P), 2),
            U = B[0],
            H = B[1],
            W = C(Object(r.useState)(L), 2),
            F = W[0],
            V = W[1],
            q = C(Object(r.useState)(!1), 2),
            z = q[0],
            Y = q[1],
            $ = C(Object(r.useState)(null), 2),
            Z = $[0],
            J = $[1],
            K = C(Object(r.useState)(!1), 2),
            X = K[0],
            Q = K[1],
            ee = C(Object(r.useState)({}), 2),
            te = ee[0],
            ne = ee[1],
            re = C(Object(r.useState)(!1), 2),
            oe = re[0],
            ie = re[1],
            ae = C(Object(r.useState)(!1), 2),
            ce = ae[0],
            le = ae[1],
            ue = C(Object(r.useState)([]), 2),
            se = ue[0],
            de = ue[1],
            fe = C(Object(a.a)(), 1)[0],
            pe = Object(i.d)(),
            me = Object(r.useRef)(null),
            he = "OutlineDestinationCreateTool",
            ge = v.a.getTool(he)
          Object(r.useLayoutEffect)(
            function () {
              Q(!1),
                null !== me.current && (J(me.current), (me.current = null)),
                0 === n.length && le(!1)
            },
            [n],
          ),
            ...
            Object(r.useEffect)(function () {
              var e = function (e) {
                  G(e.IsText ? e.getCustomData("trn-annot-preview") : D),
                    H({ x: e.X, y: e.Y }),
                    V(e.PageNumber)
                },
                t = function () {
                  v.a.getOutlines(function (e) {
                    pe(O.a.setOutlines(e))
                  })
                },
                n = function () {
                  J(null)
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          ...
                          return (e.next = 6), y.a.addRootOutline(c, F, o, i, 0)
                        case 6:
                          ;(a = e.sent), (e.next = 12)
                          break
                        case 9:
                          return (
                            (e.next = 11), y.a.addNewOutline(c, Z, F, o, i, 0)
                          )
                        case 11:
                          a = e.sent
                        case 12:
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            ...
                            (o = n.y),
                            (e.next = 3),
                            y.a.setOutlineDestination(t, F, r, o, 0)
                          )
                        case 3:
                          ;(me.current = t), be()
                        case 5:
          ...
          var xe = function (e, t, n) {
              var r = we(e),
                o = we(t)
              de([]),
                n.call(y.a, r, o).then(function (e) {
                  be(), (me.current = e)
                }),
                v.a.goToOutline(e)
            },
            ke = function (e, t) {
              xe(e, t, y.a.moveOutlineAfterTarget)
            },
            Te = function (e, t) {
              xe(e, t, y.a.moveOutlineBeforeTarget)
            },
            Le = function (e, t) {
              xe(e, t, y.a.moveOutlineInTarget)
            },
            Ne = (function () {
              var e = _(
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          t.sort().reverse(),
                            (n = {
                              message: fe("warning.deleteOutline.message"),
                              title: fe("warning.deleteOutline.title"),
                              confirmBtnText: fe("action.delete"),
                              onConfirm: (function () {
                                var e = _(
                                  S().mark(function e() {
                                    var n, r
          ...
          return t
            ...
            : o.a.createElement(
                  ...
                  z &&
                    (ce
                      ? o.a.createElement(m.a, {
                          ...
                          label: fe("option.bookmarkOutlineControls.done"),
                          disabled: X,
                          onClick: function () {
                            return le(!1)
                          },
                      ...
                      : o.a.createElement(m.a, {
                          className: "bookmark-outline-control-button",
                          dataElement: b.a.OUTLINE_MULTI_SELECT,
                          label: fe("action.edit"),
                          disabled: X || 0 === n.length,
                          onClick: function () {
                            le(!0), de([])
                          },
                        })),
                ...
                o.a.createElement(
                  ...
                  {
                    value: {
                      currentDestPage: j[F - 1],
                      currentDestText: M,
                      setActiveOutlinePath: J,
                      activeOutlinePath: Z,
                      isOutlineActive: function (e) {
                        return we(e) === Z
                      },
                      setAddingNewOutline: Q,
                      isAddingNewOutline: X,
                      setEditingOutlines: ne,
                      editingOutlines: te,
                      selectedOutlines: se,
                      isAnyOutlineRenaming: oe,
                      isMultiSelectMode: ce,
                      shouldAutoExpandOutlines: T,
                      isOutlineEditable: z,
                      addNewOutline: ye,
                      updateOutlines: be,
                      renameOutline: Ne,
                      updateOutlineDest: Ee,
                      removeOutlines: je,
                    },
                  },
                  x && o.a.createElement(d.a, null),
                  o.a.createElement(
                    c.a,
                    { backend: l.m ? s.a : u.a },
                        ...
                        return o.a.createElement(f.a, {
                          ...
                          setMultiSelected: function (e, t) {
                            se.find(function (t) {
                              ...
                              ? t ||
                                de(
                                  se.filter(function (t) {
                                    return t !== e
                                  }),
                                )
                              : t && de([].concat(A(se), [e]))
                          },
                          moveOutlineInward: Le,
                          moveOutlineBeforeTarget: Te,
                          moveOutlineAfterTarget: ke,
                        })
                      }),
                      X &&
                        null === Z &&
                    ...
                    o.a.createElement(
                      ...
                      ce
                        ...
                        : o.a.createElement(m.a, {
                            ...
                            disabled: X,
                            label: ""
                              .concat(fe("action.add"), " ")
                              .concat(fe("component.outlinePanel")),
                            onClick: function () {
                              return Q(!0)
                            },
                          }),
