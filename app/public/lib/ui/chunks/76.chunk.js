  ...
  [76],
  {
    1833: function (e, t, a) {
      ...
      var m = function (e) {
        ...
        E = a(36),
        f = a(5),
        g = { pageNumbers: d.a.arrayOf(d.a.number), warn: d.a.bool }
      function b(e) {
        var t = Object(o.d)(),
          a = e.pageNumbers,
          n = e.warn
        return r.a.createElement(m, {
          rotateCounterClockwise: function () {
            n ? !Object(s.k)(a, t) && Object(s.p)(a) : Object(s.p)(a),
              Object(E.l)() &&
                t(l.a.closeElement(f.a.PAGE_MANIPULATION_OVERLAY))
          },
      ...
      function w(e) {
        ...
        return n.map(function (e, t) {
          var n = e.dataElement,
            ...
            c = n || "".concat(l, "-").concat(t)
          return (
            i ||
              ("divider" === l &&
                (i = r.a.createElement("div", { className: "divider" })),
              "customPageOperation" === l &&
                (i = r.a.createElement(N, C({ key: n, pageNumbers: a }, e)))),
      ...
      var P = function (e) {
          var t = e.pageNumbers,
            ...
            c = Object(n.useCallback)(
              function () {
                i(l.a.setPageManipulationOverlayAlternativePosition(null)),
                  i(l.a.closeElements([f.a.PAGE_MANIPULATION_OVERLAY]))
              },
              [i],
            ),
            u = A.a.getDocument(),
            ...
            s = m === h.a.XOD,
            p = m === h.a.OFFICE || m === h.a.LEGACY_OFFICE,
            d = a
          if (s || p) {
            var E = d.reduce(function (e, t, a) {
              var n,
                r,
                o = t.dataElement
              "pageAdditionalControls" === o &&
                (e.push(a),
                "divider" ===
                  (null === (n = d[a + 1]) || void 0 === n ? void 0 : n.type) &&
                  e.push(a + 1))
              "pageManipulationControls" === o &&
                (e.push(a),
                "divider" ===
          ...
          return (
            Object(n.useEffect)(function () {
              return (
                A.a.addEventListener("documentLoaded", c),
                function () {
                  A.a.removeEventListener("documentLoaded", c)
                }
              )
            }, []),
            r.a.createElement(
      ...
      var M = function () {
        ...
        return r.a.createElement(
          k.a,
          {
            menu: f.a.PAGE_MANIPULATION_OVERLAY,
            trigger: f.a.PAGE_MANIPULATION_OVERLAY_BUTTON,
